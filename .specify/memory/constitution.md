...
- Added standards: None
- Removed sections: None
- Change summary: Grammar fix for supported DNN versions; add explicit Offcanvas a11y gate in Quality Gates; mark plan-template updated and align footer path/version.
- Templates requiring updates:
	✅ .specify/templates/plan-template.md (Constitution Check includes Offcanvas DDR gate; footer aligned to v1.9.1 and path)
...
- Platform: DNN Community Edition 9.13.x (Web Forms skinning). Theme need to support only latest DNN from 9.13.x and later.
 - Platform: DNN Community Edition 9.13.x (Web Forms skinning). Theme needs to support only the latest DNN 9.13.x and later.
...
4. Run Quality Gates (must PASS):
	 ...
	 - Offcanvas mobile navigation a11y: focus trap, Esc to close, and correct ARIA attributes verified
...
**Version**: 1.9.1 | **Ratified**: 2025-09-24 | **Last Amended**: 2025-09-25