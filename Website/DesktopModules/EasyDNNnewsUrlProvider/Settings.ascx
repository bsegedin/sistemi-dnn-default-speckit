	...
	<table class="auto-style1">
		...
		<tr>
			<td class="auto-style5">
				<asp:Label ID="lblcbRewriteArticleLinks" runat="server" Text="Rewrite article links:" /></td>
			<td class="auto-style6">
				<asp:CheckBox ID="cbRewriteArticleLinks" runat="server" />
			</td>
		</tr>
		<tr>
			<td class="auto-style2">
		...
		<tr>
			<td class="auto-style5">
				<asp:Label ID="lblRewritePagerLinks" runat="server" Text="Rewrite pager links:" /></td>
			<td class="auto-style6">
