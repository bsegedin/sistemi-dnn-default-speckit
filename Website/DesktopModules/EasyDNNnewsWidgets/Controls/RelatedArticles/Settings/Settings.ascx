<%@ control language="C#" autoeventwireup="true" inherits="EasyDNNSolutions.Modules.EasyDNNNews.Widgets.Controls.RelatedArticles.Settings.SettingsRelatedArticles, App_Web_settings.ascx.a7f0c1d5" %>
	...
	jQuery(function ($) {
		...
		$('#<%= rblFilterRelatedArticles.ClientID %> input').change(function () {
				...
				if ($(this).val() == 0) {
					...
					$(tempeds__eds__racb).prop("disabled", true);
					$(tempeds__eds__racb).prop("checked", "checked");
				}
				else {
					var tempeds__eds__racb = $('#<%=cbIncludeTagsInRelated.ClientID %>')[0];
...
<div class="sectionBox noPadding">
		...
		<ContentTemplate>
			<table class="optionsList fullWidthTable tablePadding5 strippedTable noBorder">
				<tr>
					...
					<td>
						<asp:DropDownList ID="ddlTheme" runat="server" OnSelectedIndexChanged="ddlTheme_SelectedIndexChanged" AutoPostBack="True" ValidationGroup="vgRelatedArticles" />
						<asp:CompareValidator ID="cvThemeSelect" resourcekey="SelectTheme.ErrorMessage" runat="server" ForeColor="Red" ControlToValidate="ddlTheme" Display="Dynamic" ErrorMessage="Please select theme." Operator="NotEqual" ValidationGroup="vgRelatedArticles"
							ValueToCompare="" />
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						...
						<asp:RequiredFieldValidator ID="rfvHtmlTemplate" runat="server" ControlToValidate="ddlListTemplate" InitialValue="" ForeColor="Red" ValidationGroup="vgRelatedArticles" resourcekey="SelectHtmlTemplate.ErrorMessage"></asp:RequiredFieldValidator>
					</td>
				</tr>
				<tr>
					<td class="tdLabel">
	...
	<asp:UpdateProgress ID="uppTheme" runat="server" AssociatedUpdatePanelID="upModuleTheme" DisplayAfter="100" DynamicLayout="true">
		<ProgressTemplate>
			<img alt="ajaxLoading" src="<%=Regex.Replace(ControlPath, "EasyDNNnewsWidgets/Controls/RelatedArticles/Settings", "EasyDNNnews", RegexOptions.IgnoreCase)%>images/settings/ajaxLoading.gif" />
		</ProgressTemplate>
	</asp:UpdateProgress>
	<div class="sectionBoxSubtitle highlighted3">
	...
	<table class="optionsList fullWidthTable tablePadding5 strippedTable noBorder">
		<tr>
			...
			<td>
				...
				<asp:RequiredFieldValidator ID="rfvItemsPerPage" runat="server" ControlToValidate="tbItemsPerPage" Display="Dynamic" resourcekey="ThisFiledIsRequired.ErrorMessage" ErrorMessage="This filed is required." SetFocusOnError="True" ValidationGroup="vgRelatedArticles" />
		...
		<tr runat="server" id="tr_eds_relatedRestriction" visible="false">
			<td class="tdLabel">
		...
		<tr runat="server" id="tr_eds_relatedFilterBy" visible="false">
			<td class="tdLabel">
		...
		<tr runat="server" id="rowFilterByEvents" visible="false">
			<td class="tdLabel">
			...
			<td>
				<div class="edNews_inputGroup displayInline">
					<asp:RadioButtonList ID="rblLimitBackEvents" runat="server" CssClass="inlineList smallRadio styledRadio" RepeatLayout="UnorderedList">
						...
						<asp:ListItem class="normalRadioButton" Value="1" Text="Show only past events" resourcekey="liShowOnlyPastEvents" />
						<asp:ListItem class="normalRadioButton" Value="2" Text="Limit to number of days:" resourcekey="liLimitToNumberOfDays" Selected="True" />
					</asp:RadioButtonList>
				</div>
				<asp:TextBox ID="tbPastEventLimit" runat="server" CssClass="smallCentered" Text="0" />
				<asp:RequiredFieldValidator ID="rfvPastEventLimit" runat="server" ControlToValidate="tbPastEventLimit" Display="Dynamic" resourcekey="ThisFiledIsRequired.ErrorMessage" ErrorMessage="This filed is required." SetFocusOnError="True" ValidationGroup="vgRelatedArticles" />
				<asp:CompareValidator ID="cvPastEventLimit" runat="server" ControlToValidate="tbPastEventLimit" Display="Dynamic" resourcekey="PleaseEnterNumberOnly.ErrorMessage" ErrorMessage="Please enter number only." Operator="DataTypeCheck" Type="Integer" ValidationGroup="vgRelatedArticles" />
			</td>
		</tr>
		<tr>
			...
			<td>
				<div class="edNews_inputGroup">
					<asp:RadioButtonList ID="rblFilterRelatedArticles" runat="server" CssClass="styledRadio smallRadio verticalList" RepeatLayout="UnorderedList">
						<asp:ListItem class="normalRadioButton" Value="1" resourcekey="ByModuleCategories" Text="By module categories"  />
						<asp:ListItem class="normalRadioButton" Value="2" resourcekey="ByArticeCategories" Text="By article categories" />
						<asp:ListItem class="normalRadioButton" Value="0" resourcekey="ShowRelatedArticlesFromAllCategories" Text="Show related articles from all categories" Selected="True" />
					</asp:RadioButtonList>
				</div>
			</td>
		</tr>
		<tr>
			...
			<td>
				<div class="switchCheckbox">
					<asp:CheckBox CssClass="normalCheckBox" ID="cbIncludeTagsInRelated" runat="server" Text=" " Checked="True" />
				</div>
			</td>
		</tr>
		<tr>
	...
	<asp:Panel ID="pnlListContentImageProperties" runat="server">
		...
		<table class="optionsList fullWidthTable tablePadding5 strippedTable noBorder">
			<tr>
				...
				<td>
					<asp:TextBox ID="tbJpegThumbnailQuality" runat="server" CausesValidation="True" MaxLength="3" ValidationGroup="vgRelatedArticles" CssClass="smallCentered" Text="97" />
					<asp:RequiredFieldValidator ID="rfvMainImageWidth1" runat="server" ControlToValidate="tbJpegThumbnailQuality" Display="Dynamic" ErrorMessage="This filed is required." ValidationGroup="vgRelatedArticles" resourcekey="ThisFiledIsRequired.ErrorMessage" />
					<asp:RangeValidator ID="rvJpegQuality" runat="server" ControlToValidate="tbJpegThumbnailQuality" Display="Dynamic" ErrorMessage="Enter value between 1 - 100." MaximumValue="100" MinimumValue="1" SetFocusOnError="True" Type="Integer" ValidationGroup="vgRelatedArticles"
			...
			<tr>
				...
				<td>
					...
					<asp:RequiredFieldValidator ID="rfvRhumbImageWidth" runat="server" ControlToValidate="tbImageThumbWidth" ErrorMessage="This filed is required." SetFocusOnError="True" ValidationGroup="vgRelatedArticles" resourcekey="ThisFiledIsRequired.ErrorMessage" />
				</td>
			</tr>
			<tr>
				<td class="tdLabel">
				...
				<td>
					...
					<asp:RequiredFieldValidator ID="rfvThumbImageHeight" runat="server" ControlToValidate="tbImageThumbHeight" ErrorMessage="This filed is required." SetFocusOnError="True" ValidationGroup="vgRelatedArticles" resourcekey="ThisFiledIsRequired.ErrorMessage" />
				</td>
			</tr>
			<tr>
				<td class="tdLabel">
		...
		<table class="optionsList fullWidthTable tablePadding5 strippedTable noBorder">
			<tr>
				...
				<td>
					...
					<asp:RequiredFieldValidator ID="rfvTitleLImit" runat="server" ControlToValidate="tbLimitTitle" ErrorMessage="This filed is required." ValidationGroup="vgRelatedArticles" resourcekey="ThisFiledIsRequired.ErrorMessage" />
				</td>
			</tr>
			<tr>
				<td class="tdLabel">
				...
				<td>
					...
					<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="tbLimitSubTitle" ErrorMessage="This filed is required." ValidationGroup="vgRelatedArticles" resourcekey="ThisFiledIsRequired.ErrorMessage" />
				</td>
			</tr>
			<tr>
				<td class="tdLabel">
				...
				<td>
					...
					<asp:RequiredFieldValidator ID="rfvSummaryLimit" runat="server" ControlToValidate="tbLimitSummary" ErrorMessage="This filed is required." ValidationGroup="vgRelatedArticles" resourcekey="ThisFiledIsRequired.ErrorMessage" />
				</td>
			</tr>
			<tr>
				<td class="tdLabel">
				...
				<td>
					...
					<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="tbArticleLimit" ErrorMessage="This filed is required." ValidationGroup="vgRelatedArticles" resourcekey="ThisFiledIsRequired.ErrorMessage" />
				</td>
			</tr>
		</table>
	</asp:Panel>
	<asp:Panel ID="pnlPaginationSettings" runat="server">
		...
		<table class="optionsList fullWidthTable tablePadding5 strippedTable noBorder" runat="server" id="tblPaginationsSettings">
			...
			<tr runat="server" id="rowNormalPaginationOptions">
				...
				<td>
					<asp:TextBox ID="tbNumberOfPagerLinks" runat="server" CssClass="smallCentered" ValidationGroup="vgRelatedArticles">10</asp:TextBox>
					<asp:RequiredFieldValidator ID="rfvNumberOfPagerLinks" runat="server" ControlToValidate="tbNumberOfPagerLinks" ErrorMessage="This filed is required." ValidationGroup="vgRelatedArticles" Display="Dynamic" resourcekey="ThisFiledIsRequired.ErrorMessage" />
				</td>
			</tr>
		</table>
	</asp:Panel>
	...
	<table class="optionsList fullWidthTable tablePadding5">
		<tr>
			...
			<td>
				<div class="edNews_inputGroup">
					<asp:RadioButtonList ID="rblModuleVisibility" runat="server" CssClass="verticalList smallRadio styledRadio" RepeatLayout="UnorderedList" Enabled="False">
						<asp:ListItem class="normalRadioButton" resourcekey="liDefaultAlwaysShowModule" Text="Default (always show module)" Value="0" />
						...
						<asp:ListItem class="normalRadioButton" resourcekey="liVisibleOnlyIfArticleDetailsMode" Selected="True" Text="Visible only if article details mode" Value="2" />
					</asp:RadioButtonList>
				</div>
			</td>
		</tr>
