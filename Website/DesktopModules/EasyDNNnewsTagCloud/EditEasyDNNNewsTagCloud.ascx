...
<div class="edNews_adminWrapper edNews_widgets mainContentWrapper topPadded bottomPadded">
	<div class="contentSection bottomPadded">
		...
		<div class="sectionBox noPadding">
			...
			<asp:Panel runat="server" ID="pnlFileterOptions">
			<table runat="server" id="tbl_filtercontent" class="optionsList fullWidthTable tablePadding5 strippedTable noBorder" cellpadding="0" cellspacing="0">
				<tr>
					<td class="tdLabel">
			...
			<table id="tblSelectCategories" runat="server" class="optionsList fullWidthTable tablePadding5" cellpadding="0" cellspacing="0" style="margin-left: auto; margin-right: auto;">
				<tr>
					<td class="tdLabel">
					<label for="<%=cbAutoAddCatChilds.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("cbAutoAddCatChilds.HelpText", true) %>" data-tooltip-position="top-right"><%=_("cbAutoAddCatChilds.Text") %></label>
					</td>
					<td>
						<div class="switchCheckbox">
			...
			<table runat="server" id="tbl_filterAuthors" class="optionsList fullWidthTable tablePadding5" cellpadding="0" cellspacing="0">
				<tr>
					<td class="tdLabel">
			...
			<table class="optionsList fullWidthTable tablePadding5" cellpadding="0" cellspacing="0">
				<tr>
					<td class="tdLabel">
						<label for="<%=cbFollowNewsModule.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblFollowNewsModule.HelpText", true) %>" data-tooltip-position="top-right"><%=_("lblFollowNewsModule.Text") %></label>
					</td>
					<td>
						<div class="switchCheckbox">
							<asp:CheckBox CssClass="normalCheckBox" ID="cbFollowNewsModule" Text="Follow news module" runat="server" Checked="False" OnCheckedChanged="cbFollowNewsModule_CheckedChanged" AutoPostBack="True" />
						</div>
					</td>
				</tr>
			</table>
