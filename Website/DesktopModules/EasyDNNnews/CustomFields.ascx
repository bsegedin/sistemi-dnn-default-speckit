			...
			<asp:Panel ID="pnlControlOptions" class="sectionBox noPadding sectionBox2" runat="server" Visible="false">
															...
															<asp:TemplateField ShowHeader="True" HeaderText="gvActionHeaderText">
																...
																<ItemTemplate>
																	<div class="itemActions diplayInline">
																		...
																		<asp:LinkButton ID="lblgvChildeParentElementsLocalize" runat="server" CausesValidation="False" CssClass="localizeAction" CommandName="Localize" Text="Translate" ResourceKey="lbgvMultiControlElementsLocalize" />
																	</div>
																</ItemTemplate>
											...
											<asp:TemplateField ShowHeader="True" HeaderText="gvActionHeaderText">
												<ItemTemplate>
													<div class="itemActions displayInline smallActions">
														...
														<asp:LinkButton ID="lbgvMultiControlElementsLocalize" runat="server" CssClass="localizeAction" CausesValidation="False" CommandName="Localize" Text="Translate" ResourceKey="lbgvMultiControlElementsLocalize" />
													</div>
												</ItemTemplate>
												<EditItemTemplate>
													<div class="itemActions displayInline smallActions">
				...
				<asp:Panel ID="pnlOtherSettings" runat="server" Visible="true">
					<table class="optionsList fullWidthTable strippedTable tablePadding5 noBorder">
						...
						<tr runat="server" id="trEditOnlyByAdmin">
							<td class="tdLabel">
								<label for="<%=cbEditOnlyByAdmin.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblEditByAdmin.HelpText", true) %>" data-tooltip-position="top-right"><%=_("lblEditByAdmin.Text") %></label>
							</td>
							<td>
								<div class="switchCheckbox">
									<asp:CheckBox ID="cbEditOnlyByAdmin" CssClass="normalCheckBox" Text="Only admin can edit:" runat="server" Checked="false" />
								</div>
							</td>
						</tr>
					</table>
					...
					<asp:Panel ID="pnlIsSearchable" runat="server" Visible="true">
						<table class="optionsList fullWidthTable strippedTable tablePadding5 noBorder">
							...
							<tr runat="server" id="rowSearchLogicalOperator" visible="false">
								<td class="tdLabel">
									<label for="<%=rblSearchLogicalOperator.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblSearchLogicalOperator.Help", true) %>" data-tooltip-position="top-right"><%=_("lblSearchLogicalOperator.Text") %></label>
								</td>
								<td>
									<div class="edNews_inputGroup">
							...
							<tr runat="server" id="trSearchMultiCheckBoxViewType" visible="false">
								...
								<td>
									<div class="edNews_inputGroup">
										<asp:RadioButtonList ID="rblSearchMultiCheckBoxViewType" runat="server" RepeatLayout="UnorderedList" CssClass="styledRadio smallRadio inlineList" AutoPostBack="True" OnSelectedIndexChanged="rblSearchMultiCheckBoxViewType_SelectedIndexChanged">
							...
							<tr runat="server" id="trLabelDisplay" visible="false">
								<td class="tdLabel">
									<label for="<%=rblSearchLogicalOperator.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblLabelDisplay.Help", true) %>" data-tooltip-position="top-right"><%=_("lblLabelDisplay.Text") %></label>
								</td>
								<td>
									<div class="edNews_inputGroup">
										<asp:RadioButtonList ID="rblLabelDisplay" runat="server" RepeatLayout="UnorderedList" CssClass="styledRadio smallRadio inlineList">
											<asp:ListItem class="normalRadioButton" resourcekey="liInline" Value="inline" Text="Inline" Selected="True" />
											<asp:ListItem class="normalRadioButton" resourcekey="liAboveElement" Value="inlineabove" Text="Above" />
										</asp:RadioButtonList>
									</div>
								</td>
							</tr>
							...
							<ContentTemplate>
								<div class="edNews_adminProgressOverlayWrapper">
									...
									<table class="optionsList fullWidthTable tablePadding5 noBorder">
										...
										<tr>
											<td class="tdLabel">
												<label for="<%=cbNewDateShowOnlyYear.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblNewDateShowOnlyYear.HelpText", true) %>" data-tooltip-position="top-right"><%=_("lblNewDateShowOnlyYear.Text") %></label>
											</td>
											<td>
												<div class="switchCheckbox">
													<asp:CheckBox ID="cbNewDateShowOnlyYear" Text="Show only year" CssClass="normalCheckBox" runat="server" Checked="false" AutoPostBack="True" OnCheckedChanged="cbNewDateShowOnlyYear_CheckedChanged" />
												</div>
											</td>
										</tr>
									</table>
