...
<asp:Panel ID="pnlMain" runat="server" CssClass="edNews_adminWrapper mainContentWrapper topPadded bottomPadded">
	<div class="contentSection bottomPadded">
		...
		<div class="sectionBox sectionBox2 noPadding">
			<div class="sectionBoxHeader">
				<span class="sectionBoxHeaderTitle"><%= _("ShareThis.Text")%></span>
			</div>
			<table class="optionsList fullWidthTable strippedTable noBorder">
				<tr>
					<td class="tdLabel strongText textTop">
						<asp:Label ID="lblShareThisInstructions" resourcekey="lblShareThisInstructions" runat="server" Text="Instructions:"></asp:Label>
					</td>
					<td class="textTop">
						<asp:HyperLink ID="hlVisitDetailInstrictionsShareThis" resourcekey="hlVisitDetailInstrictionsShareThis" runat="server" NavigateUrl="http://help.easydnnsolutions.com/user-manuals/easydnnnews/category/integrations/integration-with-sharethis" Target="_blank">For more detail instructions please visit this link.</asp:HyperLink>
						<asp:Label ID="lblShareThisDetailInstructions" resourcekey="lblShareThisDetailInstructions" runat="server"><ol><li>Visit the URL below, create and setup site profile</li><li>Go to site profile 'General settings' and copy profile id to below textbox. Profile is must start with 'ra-'.</li></ol></asp:Label>
					</td>
				</tr>
				<tr>
					<td class="tdLabel strongText">
						<asp:Label ID="lblShareThisVisitLink" resourcekey="lblShareThisVisitLink" runat="server" Text="Visit this url:"></asp:Label>
					</td>
					<td>
						<asp:HyperLink ID="hlShareThis" runat="server" NavigateUrl="https://www.sharethis.com" Target="_blank" ImageUrl="~/DesktopModules/EasyDNNnews/images/sharethis.png">ShareThis</asp:HyperLink>
					</td>
				</tr>
				<tr>
					<td class="tdLabel strongText">
						<asp:Label ID="lblShareThisProfileId" resourcekey="lblShareThisProfileId" runat="server" Text="ShareThis profile id:"></asp:Label>
					</td>
					<td>
						<div class="edNews_inputGroup inputWidth40">
							<asp:TextBox ID="tbxShareThisProfileId" runat="server" ValidationGroup="vgShareThis"></asp:TextBox>
							<asp:RequiredFieldValidator ID="rfvShareThisProfileId" CssClass="smallInfo error" runat="server" resourcekey="rfvShareThisProfileId.ErrorMessage" ControlToValidate="tbxShareThisProfileId" ErrorMessage="Please enter ShareThis profile id." ValidationGroup="vgShareThis"></asp:RequiredFieldValidator>
						</div>
					</td>
				</tr>
			</table>
			<asp:Label ID="lblShareThisRecaptchaSaveInfo" runat="server" ForeColor="#FF3300" EnableViewState="False"></asp:Label>
			<div class="mainActions smallActions">
				<asp:Button ID="btnSaveShareThis" resourcekey="btnSaveShareThis" runat="server" CssClass="downSave" Text="Add or update ShareThis profile Id" ValidationGroup="vgShareThis" OnClick="btnSaveShareThis_Click" />
				<asp:Button ID="btnDeleteExistingShareThis" resourcekey="btnDeleteExistingShareThis" runat="server" CssClass="delete" OnClientClick="return ShowWarning();" Text="Delete Existing Keys" OnClick="btnDeleteExistingShareThis_Click"/>
			</div>
		</div>
		<div class="sectionBox sectionBox2 noPadding">
			<div class="sectionBoxHeader">
				<span class="sectionBoxHeaderTitle">
					<%= _("OpenAI.Text")%>
				</span>
			</div>
			<table class="optionsList fullWidthTable strippedTable noBorder">
				<tr>
					<td class="tdLabel strongText textTop">
						<asp:Label ID="lblOpenAIInstructions" resourcekey="lblOpenAIInstructions" runat="server" Text="Instructions:" />
					</td>
					<td class="textTop">
						<asp:HyperLink ID="hlVisitDetailInstrictionsOpenAI" resourcekey="hlVisitDetailInstrictionsOpenAI" runat="server" NavigateUrl="https://help.easydnnsolutions.com/user-manuals/easydnnnews/category/integrations/integration-with-openai" Target="_blank">For more detail instructions please visit this link.</asp:HyperLink>
						<asp:Label ID="lblOpenAIDetailInstructions" resourcekey="lblOpenAIDetailInstructions" runat="server">
						<ol>
							<li>Visit the URL below, create and setup site profile</li>
							<li>Go to 'https://platform.openai.com/account/api-keys' and copy API key to below textbox.</li>
						</ol>
						</asp:Label>
					</td>
				</tr>
				<tr>
					<td class="tdLabel strongText">
						<asp:Label ID="lblOpenAIVisitLink" resourcekey="lblOpenAIVisitLink" runat="server" Text="Visit this url:" />
					</td>
					<td>
						<asp:HyperLink ID="hlOpenAI" runat="server" NavigateUrl="https://www.OpenAI.com" Target="_blank" ImageUrl="~/DesktopModules/EasyDNNnews/images/OpenAI.png">OpenAI</asp:HyperLink>
					</td>
				</tr>
				<tr>
					<td class="tdLabel strongText">
						<asp:Label ID="lblOpenAIProfileId" resourcekey="lblOpenAIProfileId" runat="server" Text="OpenAI profile id:" />
					</td>
					<td>
						<div class="edNews_inputGroup inputWidth40">
							<asp:TextBox ID="tbxOpenAIProfileId" runat="server" ValidationGroup="vgOpenAI" />
							<asp:RequiredFieldValidator ID="rfvOpenAIProfileId" CssClass="smallInfo error" runat="server" resourcekey="rfvOpenAIProfileId.ErrorMessage" ControlToValidate="tbxOpenAIProfileId" ErrorMessage="Please enter OpenAI profile id." ValidationGroup="vgOpenAI" />
						</div>
					</td>
				</tr>
				<tr>
					<td class="tdLabel strongText">
						<asp:Label ID="lblOpenAIModel" resourcekey="lblOpenAIModel" runat="server" Text="Select Open AI model to use:" />
					</td>
					<td>
						<div class="edNews_inputGroup inputWidth40">
							<asp:DropDownList ID="ddllOpenAIModel" runat="server" Enabled="false">
								<asp:ListItem Value="gpt-3.5-turbo" Text="gpt-3.5-turbo" />
							</asp:DropDownList>
						</div>
					</td>
				</tr>
			</table>
			<asp:Label ID="lblOpenAISaveInfo" runat="server" ForeColor="#FF3300" EnableViewState="False" />
			<div class="mainActions smallActions">
				<asp:Button ID="btnCheckOpenAI" resourcekey="btnCheckOpenAI" runat="server" CssClass="downSave" Text="Check OpenAI API key" ValidationGroup="vgOpenAI" OnClick="btnCheckOpenAI_Click" Visible="True" Enabled="True" />
				<asp:Button ID="btnSaveOpenAI" resourcekey="btnSaveOpenAI" runat="server" CssClass="downSave" Text="Add or update OpenAI profile Id" ValidationGroup="vgOpenAI" OnClick="btnSaveOpenAI_Click" Visible="True" Enabled="False" />
				<asp:Button ID="btnDeleteExistingOpenAI" resourcekey="btnDeleteExistingOpenAI" runat="server" CssClass="delete" OnClientClick="return ShowWarning();" Text="Delete Existing Keys" OnClick="btnDeleteExistingOpenAI_Click" />
			</div>
		</div>
	</div>
