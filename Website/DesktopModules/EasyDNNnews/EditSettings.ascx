...
<script type="text/javascript">
	...
	jQuery().ready(function ($) {
		...
		$('#<%= rblFilterRelatedArticles.ClientID %> input').change(function () {
			var tempeds__eds__ddlacb_val = $('#<%=ddlRelatedArticlesSorting.ClientID %> option:selected').val();
			if (tempeds__eds__ddlacb_val != "NumberOfMatchingTags") {
				if ($(this).val() == 0) {
					var tempeds__eds__racb = $('#<%=cbIncludeTagsInRelated.ClientID %>')[0];
					$('#<%=cbIncludeTagsInRelated.ClientID %>')[0].checked = true;
					$(tempeds__eds__racb).checked = true;

					$(tempeds__eds__racb).attr("disabled", true);
				}
				else {
					var tempeds__eds__racb = $('#<%=cbIncludeTagsInRelated.ClientID %>')[0];
					$(tempeds__eds__racb).removeAttr("disabled");
				}
			}
		});
		...
		var tempeds__eds__ddlacb_val = $('#<%=ddlRelatedArticlesSorting.ClientID %> option:selected').val();
		if (tempeds__eds__ddlacb_val != "NumberOfMatchingTags") {
			var tempeds__eds__racb_val = $('#<%=rblFilterRelatedArticles.ClientID %> input:checked').val();
			if (tempeds__eds__racb_val == 0) {
				var tempeds__eds__racb = $('#<%=cbIncludeTagsInRelated.ClientID %>')[0];
				$('#<%=cbIncludeTagsInRelated.ClientID %>')[0].checked = true;
				$(tempeds__eds__racb).checked = true;
				$(tempeds__eds__racb).attr("disabled", true);
		...
		$('.edNews__toggleNext2TableRow').on('change', 'input[type="checkbox"]', function () {
			var $this = $(this);
			if (!this.checked) {
				$this.closest('tr').next('tr').hide();
		...
		$('input[type="checkbox"]', '.edNews__toggleNext2TableRow').trigger("change");


		$('.edNews__toggleNextSiblings').on('change', 'input[type="checkbox"]', function () {
		...
		$('input[type="checkbox"]', '.edNews__toggleNextSiblings').trigger("change");
		...
		$('#<%=cbCreateAMPArticles.ClientID %>').trigger("change");

		$('#<%=cbForceMapsSettings.ClientID%>,#<%=cbEnableCanonicalLink.ClientID%>').on('change', function () {
			if (!this.checked) {
				$(this).closest("tr").nextAll().hide();
			}
			else {
		...
		$('#<%=cbForceMapsSettings.ClientID %>').trigger("change");
		...
		$('#<%=cbFeaturedArticles.ClientID %>').on('change', function () {
			if (this.checked) {
				...
				$('#<%=cbExcludeFeaturedArticles.ClientID %>')[0].checked = false;
			}
		});
		...
		$('#<%=cbExcludeFeaturedArticles.ClientID %>').on('change', function () {
			if (this.checked)
				$('#<%=cbFeaturedOnTop.ClientID %>')[0].checked = false;
			$('#<%=cbFeaturedArticles.ClientID %>')[0].checked = false;
		});
		...
		$('#<%=cbSimpleForumModuleModulesByCategory.ClientID %>').on('change', function () {

			$('#<%=divForumInstanesSelection.ClientID%>').css('display', (this.checked ? '' : 'none'));
		});

		if ($('#<%=cbSimpleForumModuleModulesByCategory.ClientID %>').length)
			$('#<%=divForumInstanesSelection.ClientID%>').css('display', ($('#<%=cbSimpleForumModuleModulesByCategory.ClientID %>')[0].checked ? '' : 'none'));

		$('#<%=cbSimpleForumModuleModulesByCategory.ClientID %>').trigger("change");
	...
	function TemplateEditLink_Init() {
		...
		$("#<%=ddlGravityGallerySelectTemplate.ClientID %>").change(function () {
			EditTemplateLinkChange($(this), $("#<%=hlEditZeroGravityGallerySelectTemplate.ClientID %>"));
		});
	}
	...
	<div class="edNews_wrapper">
		<ul class="edNews_topActions">
			...
			<li class="edNews_close">
				<asp:HyperLink runat="server" ID="linkClose"><span><%=_("btnCancelResource1")%></span></asp:HyperLink>
			</li>
		</ul>
			...
			<div class="sectionBox noPadding">
				...
				<asp:Panel ID="pnlMainDisplaySettigs" runat="server" CssClass="settings_category_container edNews_numberedOptions">
					...
					<asp:Panel ID="pnlMainDisplaySettigsTable" runat="server" CssClass="category_content">
						<table class="optionsList fullWidthTable strippedTable noBorder">
							...
							<tr>
								<td class="tdLabel">
									<label for="<%=ddlCustomResxFolder.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblCustomResxFolder.HelpText", true) %>" data-tooltip-position="top-right"><%=_("lblCustomResxFolder.Text") %></label>
								</td>
								<td>
									<asp:DropDownList ID="ddlCustomResxFolder" runat="server">
									</asp:DropDownList>
								</td>
							</tr>
						</table>
				...
				<asp:Panel ID="pnlAdvancedArticleSettings" runat="server" CssClass="settings_category_container edNews_numberedOptions">
					...
					<asp:Panel ID="pnlAdvancedArticleSettingsSourceTable" runat="server" CssClass="category_content">
						<table class="optionsList strippedTable fullWidthTable noBorder">
							...
							<tr>
								<td class="tdLabel width50">
									<label for="<%=cbRemoveArticleListWrapper.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblRemoveArticleListWrapper.Help", true) %>" data-tooltip-position="top-right"><%=_("lblRemoveArticleListWrapper.Text") %></label>
								</td>
								<td>
									<div class="switchCheckbox">
										<asp:CheckBox CssClass="normalCheckBox" ID="cbRemoveArticleListWrapper" Text="Remove article list wrapper:" runat="server" />
									</div>
								</td>
							</tr>
							<tr>
								<td class="tdLabel width50">
									<label for="<%=cbOpenPdfInBrowser.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblOpenPdfInBrowser.Help", true) %>" data-tooltip-position="top-right"><%=_("lblOpenPdfInBrowser.Text") %></label>
								</td>
								<td>
									<div class="switchCheckbox">
										<asp:CheckBox CssClass="normalCheckBox" ID="cbOpenPdfInBrowser" Text="Open PDF files in browser:" runat="server" Checked="True" />
									</div>
								</td>
							</tr>
						</table>
						...
						<table class="optionsList strippedTable fullWidthTable noBorder" runat="server" id="tblDefaultArticleFilter">
							...
							<tr>
								...
								<td>
									...
									<div class="switchCheckbox">
										<asp:CheckBox CssClass="normalCheckBox" ID="cbExcludeFeaturedArticles" Text="Keep featured articles on top" runat="server" />
									</div>
									<label for="<%=cbExcludeFeaturedArticles.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblExcludeFeaturedArticles.HelpText", true) %>" data-tooltip-position="top-right"><%=_("lblExcludeFeaturedArticles.Text") %></label>
								</td>
							</tr>
							<tr>
								<td class="tdLabel">
								...
								<td>
									<div class="edNews_inputGroup displayInline">
										<asp:RadioButtonList ID="rblLimitBackEvents" runat="server" CssClass="styledRadio inlineList smallRadio" RepeatLayout="UnorderedList">
											...
											<asp:ListItem class="normalRadioButton" Value="ShowOnlyPastEvents" Text="Show only past events" resourcekey="ShowOnlyPastEvents" />
							...
							<ContentTemplate>
								<div class="edNews_adminProgressOverlayWrapper">
									...
									<table class="optionsList fullWidthTable strippedTable noBorder">
										...
										<tr id="trZeroGravityGallerySelectTemplate" runat="server" visible="false">
											<td class="tdLabel">
											...
											<td>
												...
												<div class="mainActions smallActions displayInline noMargin">
													<asp:HyperLink runat="server" ID="hlEditZeroGravityGallerySelectTemplate" Text="Edit" CssClass="primaryAction" Target="_blank" />
												</div>
											</td>
										</tr>
										<tr>
								...
								<ContentTemplate>
									<div class="edNews_adminProgressOverlayWrapper">
										...
										<table runat="server" id="tblCommonGallerySettings" class="optionsList strippedTable fullWidthTable noBorder">
											...
											<tr id="trFixedResponsiveLayoutTypeSelect" runat="server">
												<td class="tdLabel">
											...
											<table class="optionsList fullWidthTable strippedTable noBorder">
												...
												<tr>
													...
													<td>
														...
														<asp:RequiredFieldValidator ID="rfvGalleryHeight" runat="server" ControlToValidate="tbxGalleryHeight" ErrorMessage="This filed is required." SetFocusOnError="True" ValidationGroup="vgSettings" resourcekey="rfvRhumbImageWidth1Resource1.ErrorMessage"
															Display="Dynamic" />
														<asp:CompareValidator ID="cvtbxGalleryHeight" runat="server" ControlToValidate="tbxGalleryHeight" Display="Dynamic" ErrorMessage="Please enter number only." Operator="DataTypeCheck" Type="Integer" ValidationGroup="vgSettings" resourcekey="cvLightBoxGalleryNumberOfItems0Resource1.ErrorMessage" />
												...
												<tr>
													...
													<td>
														...
														<asp:RequiredFieldValidator ID="rfvChameleonJpegQuality" runat="server" ControlToValidate="tbChameleonJpegQuality" Display="Dynamic" ErrorMessage="This filed is required." ValidationGroup="vgSettings" resourcekey="rfvChameleonJpegQuality.ErrorMessage" />
														<asp:RangeValidator ID="rvChameleonJpegQuality" runat="server" ControlToValidate="tbChameleonJpegQuality" Display="Dynamic" ErrorMessage="Enter value between 1 - 100." MaximumValue="100" MinimumValue="1" SetFocusOnError="True" Type="Integer" ValidationGroup="vgSettings" resourcekey="rvChameleonJpegQuality.ErrorMessage" />
													</td>
												</tr>
												<tr>
													<td class="tdLabel textTop">
													...
													<td>
														<div class="edNews_inputGroup">
															<asp:RadioButtonList ID="rblChameleonResizeMethod" runat="server" AutoPostBack="True" CssClass="verticalList styledRadio smallRadio" RepeatLayout="UnorderedList">
										...
										<asp:Panel ID="pnlLightboxGallery" runat="server">
											<table class="optionsList fullWidthTable strippedTable noBorder">
												...
												<tr id="trGalleryJpegQuality" runat="server">
													<td class="tdLabel">
														<label for="<%=tbGalleryJpegQuality.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lbGalleryJpegQuality.Help", true) %>" data-tooltip-position="top-right"><%=_("lbGalleryJpegQuality.Text") %></label>
													</td>
													<td>
														<asp:TextBox ID="tbGalleryJpegQuality" runat="server" CssClass="smallCentered">97</asp:TextBox>
														<asp:RequiredFieldValidator ID="rfvGalleryJpegQuality" runat="server" ControlToValidate="tbGalleryJpegQuality" Display="Dynamic" ErrorMessage="This filed is required." ValidationGroup="vgSettings" resourcekey="rfvGalleryJpegQuality.ErrorMessage" />
														<asp:RangeValidator ID="rvGalleryJpegQuality" runat="server" ControlToValidate="tbGalleryJpegQuality" Display="Dynamic" ErrorMessage="Enter value between 1 - 100." MaximumValue="100" MinimumValue="1" SetFocusOnError="True" Type="Integer" ValidationGroup="vgSettings" resourcekey="rvGalleryJpegQuality.ErrorMessage" />
													</td>
												</tr>
												<tr>
													<td class="tdLabel">
												...
												<tr id="trLightboxGalleryResizeMethod" runat="server">
													<td class="tdLabel">
												...
												<tr id="trDisplayItemTitleLightBox" runat="server">
													<td class="tdLabel">
												...
												<tr id="trDisplayItemDescriptionLightBox" runat="server">
													<td class="tdLabel">
											...
											<table class="optionsList fullWidthTable strippedTable noBorder">
												...
												<tr>
													...
													<td>
														...
														<asp:RequiredFieldValidator ID="rfvGravityGalleryJpegQuality" runat="server" ControlToValidate="tbGravityGalleryJpegQuality" Display="Dynamic" ErrorMessage="This filed is required." ValidationGroup="vgSettings" resourcekey="rfvGravityGalleryJpegQuality.ErrorMessage" />
														<asp:RangeValidator ID="rvGravityGalleryJpegQuality" runat="server" ControlToValidate="tbGravityGalleryJpegQuality" Display="Dynamic" ErrorMessage="Enter value between 1 - 100." MaximumValue="100" MinimumValue="1" SetFocusOnError="True" Type="Integer" ValidationGroup="vgSettings" resourcekey="rvGravityGalleryJpegQuality.ErrorMessage" />
													</td>
												</tr>
												<tr>
													<td class="tdLabel">
				...
				<asp:Panel ID="pnlImageInPostSettingsSource" runat="server" CssClass="settings_category_container edNews_numberedOptions">
					...
					<asp:Panel ID="pnlImageInPostSettingsSourceTable" runat="server" CssClass="category_content">
						...
						<table class="optionsList fullWidthTable noBorder">
							...
							<tr>
								<td class="tdLabel">
									<label for="<%=cbAutoSelectFirstCategory.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblAutoSelectFirstCategory.HelpText", true) %>" data-tooltip-position="top-right"><%=_("lblAutoSelectFirstCategory.Text") %></label>
								</td>
								<td>
									<div class="switchCheckbox">
										<asp:CheckBox CssClass="normalCheckBox" ID="cbAutoSelectFirstCategory" runat="server" Text=" " />
									</div>
								</td>
							</tr>
						</table>
						...
						<table class="optionsList fullWidthTable strippedTable noBorder">
							...
							<tr>
								<td class="tdLabel">
									<label for="<%=ddlGalleryOrderBy.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblGalleryOrderBy.Help", true) %>" data-tooltip-position="top-right"><%=_("lblGalleryOrderBy.Text") %></label>
								</td>
								<td>
									<div class="edNews_inputGroup displayInline">
										<asp:DropDownList ID="ddlGalleryOrderBy" runat="server">
											<asp:ListItem Value="0" resourcekey="liAscending" Text="Ascending" />
											<asp:ListItem Value="1" resourcekey="liDescending" Text="Descending" />
										</asp:DropDownList>
									</div>
								</td>
							</tr>
						...
						<div class="sectionBoxSubtitle highlighted3">
							<span><%=_("PostingToJournal.Text")%></span>
						</div>
						<table class="optionsList fullWidthTable strippedTable noBorder">
							<tr>
								<td class="tdLabel">
									<label for="<%=cbPostToJournalOn.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblPostToJournalOn.Help", true) %>" data-tooltip-position="top-right"><%=_("lblPostToJournalOn.Text") %></label>
								</td>
								<td>
									<div class="switchCheckbox">
										<asp:CheckBox CssClass="normalCheckBox" ID="cbPostToJournalOn" runat="server" Text=" " />
									</div>
								</td>
							</tr>
							<tr>
								<td class="tdLabel">
									<label for="<%=cbHideSharingPanel.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblHideSharingPanel.Help", true) %>" data-tooltip-position="top-right"><%=_("lblHideSharingPanel.Text") %></label>
								</td>
								<td>
									<div class="switchCheckbox">
										<asp:CheckBox CssClass="normalCheckBox" ID="cbHideSharingPanel" runat="server" Text=" " />
									</div>
								</td>
							</tr>
							<tr>
								<td class="tdLabel">
									<label for="<%=ddlVisibilitySharing.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblVisibilitySharing.Help", true) %>" data-tooltip-position="top-right"><%=_("lblVisibilitySharing.Text") %></label>
								</td>
								<td>
									<div class="edNews_inputGroup displayInline">
										<asp:DropDownList ID="ddlVisibilitySharing" runat="server">
											<asp:ListItem Value="E" resourcekey="liE" Text="Everyone" />
											<asp:ListItem Value="C" resourcekey="liC" Text="Community members" />
											<asp:ListItem Value="F" resourcekey="liF" Text="Friends" />
											<asp:ListItem Value="U" resourcekey="liU" Text="Private" />
										</asp:DropDownList>
									</div>
								</td>
							</tr>
						...
						<asp:UpdatePanel ID="upCommentsSettings" runat="server" OnUnload="UpdatePanel_Unload">
							<ContentTemplate>
								<div class="edNews_adminProgressOverlayWrapper">
											...
											<td colspan="2" class="textCenter">
												<div class="edNews_inputGroup">
													<asp:RadioButtonList ID="rblCommensSource" runat="server" AutoPostBack="true" OnSelectedIndexChanged="rblCommensSource_SelectedIndexChanged" CssClass="inlineList styledRadio smallRadio" RepeatLayout="UnorderedList">
														...
														<asp:ListItem class="normalRadioButton" Value="SimpleForum" resourcekey="liSimpleForum" Enabled="False">Simple Forum Comments integration</asp:ListItem>
													</asp:RadioButtonList>
												</div>
											</td>
										</tr>
									...
									<asp:Panel ID="pnlSimpleForumCommentsOptions" runat="server" Visible="false">
										<table class="optionsList fullWidthTable strippedTable noBorder">
											<tr>
												<td class="tdLabel">
													<label for="<%=ddlSimpleForumDefaultModuleInstanceToOpenTopicDetails.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblSimpleForumModuleInstanceToOpenTopicDetails.HelpText", true) %>" data-tooltip-position="top-right"><%=_("lblSimpleForumModuleInstanceToOpenTopicDetails.Text") %></label>
												</td>
												<td>
													<div>
														<asp:DropDownList ID="ddlSimpleForumDefaultModuleInstanceToOpenTopicDetails" runat="server"></asp:DropDownList>
													</div>
												</td>
											</tr>
											<tr>
												<td class="tdLabel">
													<label for="<%=ddlSimpleForumDefaultCategory.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblSimpleForumModuleSelectDefaultCategory.HelpText", true) %>" data-tooltip-position="top-right"><%=_("lblSimpleForumModuleSelectDefaultCategory.Text") %></label>
												</td>
												<td>
													<asp:DropDownList ID="ddlSimpleForumDefaultCategory" runat="server"></asp:DropDownList>
												</td>
											</tr>
											<tr>
												<td class="tdLabel textTop">
													<label for="<%=cbSimpleForumModuleModulesByCategory.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblSimpleForumModuleModulesByCategory.HelpText", true) %>" data-tooltip-position="top-right"><%=_("lblSimpleForumModuleModulesByCategory.Text") %></label>
												</td>
												<td>
													<div class="switchCheckbox">
														<asp:CheckBox CssClass="normalCheckBox" ID="cbSimpleForumModuleModulesByCategory" runat="server" Checked="False" Text=" " />
													</div>
													<div runat="server" id="divForumInstanesSelection" style="display: none;">
														<asp:PlaceHolder ID="phDinamicTreeViewForum" runat="server"></asp:PlaceHolder>
													</div>
												</td>
											</tr>
										</table>
									...
									<asp:Panel ID="pnlCommentsOptions" runat="server">
										<table class="optionsList fullWidthTable strippedTable noBorder">
											...
											<tr>
												<td class="tdLabel">
													<label for="<%=rblCommentsSortingOrder.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblCommentsSortingOrder.HelpText", true) %>" data-tooltip-position="top-right"><%=_("lblCommentsSortingOrder.Text") %></label>
												</td>
												<td>
													<div class="edNews_inputGroup displayInline">
														<asp:RadioButtonList ID="rblCommentsSortingOrder" runat="server" CssClass="inlineList styledRadio smallRadio" RepeatLayout="UnorderedList">
															<asp:ListItem class="normalRadioButton" resourcekey="liAscending" Value="0" Selected="True">Ascending</asp:ListItem>
															<asp:ListItem class="normalRadioButton" resourcekey="liDescending" Value="1">Descending</asp:ListItem>
														</asp:RadioButtonList>
													</div>
												</td>
											</tr>
											<tr>
												<td class="tdLabel">
													<label for="<%=tbCommentsPageSize.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblCommentsPageSize.HelpText", true) %>" data-tooltip-position="top-right"><%=_("lblCommentsPageSize.Text") %></label>
												</td>
												<td>
													<asp:TextBox ID="tbCommentsPageSize" runat="server" CssClass="smallCentered">0</asp:TextBox>
													<asp:RequiredFieldValidator ID="rfvCommentsPageSize" runat="server" ControlToValidate="tbCommentsPageSize" Display="Dynamic" ErrorMessage="This filed is required." resourcekey="rfvRSSNumberOfCharacters.ErrorMessage" SetFocusOnError="True" ValidationGroup="vgSettings" />
													<asp:CompareValidator ID="cvCommentsPageSize" runat="server" ControlToValidate="tbCommentsPageSize" Display="Dynamic" ErrorMessage="Please enter number only." Operator="DataTypeCheck" resourcekey="cvLightBoxGalleryNumberOfItems0Resource1.ErrorMessage" Type="Integer" ValidationGroup="vgSettings" />
												</td>
											</tr>
										</table>
									</asp:Panel>
					...
					<asp:Panel ID="pnlRelatedPrintRSSSetingsSourceTable" runat="server" CssClass="category_content">
						...
						<table class="optionsList fullWidthTable strippedTable noBorder">
							...
							<tr>
								...
								<td>
									<asp:DropDownList ID="ddlRelatedArticlesSorting" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlRelatedArticlesSorting_SelectedIndexChanged">
							...
							<tr>
								<td class="tdLabel">
									<label for="<%=cbIncludeTagsInRelated.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblIncludeTagsInRelated.HelpText", true) %>" data-tooltip-position="top-right"><%=_("lblIncludeTagsInRelated.Text") %></label>
								</td>
								<td>
									<div class="switchCheckbox">
										<asp:CheckBox CssClass="normalCheckBox" ID="cbIncludeTagsInRelated" runat="server" Text=" " />
									</div>
								</td>
							</tr>
						</table>
						...
						<table class="optionsList fullWidthTable strippedTable noBorder">
							...
							<tr>
								<td class="tdLabel">
									<label for="<%=cbAddFacebookInstantArticleInRss.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblAddFacebookInstantArticleInRss.Help", true) %>" data-tooltip-position="top-right"><%=_("lblAddFacebookInstantArticleInRss.Text") %></label>
								</td>
								<td>
									<div class="switchCheckbox edNews__toggleNextTableRow">
										<asp:CheckBox CssClass="normalCheckBox" ID="cbAddFacebookInstantArticleInRss" runat="server" Checked="False" Text=" " />
									</div>
								</td>
							</tr>
							<tr>
								<td class="tdLabel">
									<label for="<%=ddlFacebookInstantArticleTemplate.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblFacebookInstantArticleTemplate.HelpText", true) %>" data-tooltip-position="top-right"><%=_("lblFacebookInstantArticleTemplate.Text") %></label>
								</td>
								<td>
									<asp:DropDownList ID="ddlFacebookInstantArticleTemplate" runat="server" />
								</td>
							</tr>
						</table>
						<div class="sectionBoxSubtitle highlighted3">
				...
				<asp:Panel ID="pnlAuthorProfilesMain" runat="server" CssClass="settings_category_container edNews_numberedOptions">
					...
					<asp:Panel ID="pnlAuthorProfiles" runat="server" CssClass="category_content">
						...
						<table class="optionsList fullWidthTable strippedTable noBorder">
							...
							<tr>
								<td class="tdLabel">
									<label for="<%=cbContactFormTermsAndConditionsAgreement.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblContactFormTermsAndConditionsAgreement.Help", true) %>" data-tooltip-position="top-right"><%=_("lblContactFormTermsAndConditionsAgreement.Text") %></label>
								</td>
								<td class="edNews__visibleRequiredToggles">
									<div class="switchCheckbox">
										<asp:CheckBox CssClass="normalCheckBox" ID="cbContactFormTermsAndConditionsAgreement" resourcekey="cbVisible" runat="server" Checked="False" Text="Visible" />
									</div>
									<label for="<%=cbContactFormTermsAndConditionsAgreement.ClientID %>"><%=_("cbVisible.Text") %></label>
								</td>
							</tr>
							<tr>
								<td class="tdLabel">
									<label for="<%=cbContactFormEmailUseAgreement.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblContactFormEmailUseAgreement.Help", true) %>" data-tooltip-position="top-right"><%=_("lblContactFormEmailUseAgreement.Text") %></label>
								</td>
								<td class="edNews__visibleRequiredToggles">
									<div class="switchCheckbox">
										<asp:CheckBox CssClass="normalCheckBox" ID="cbContactFormEmailUseAgreement" resourcekey="cbVisible" runat="server" Checked="False" Text="Visible" />
									</div>
									<label for="<%=cbContactFormEmailUseAgreement.ClientID %>"><%=_("cbVisible.Text") %></label>
								</td>
							</tr>
							<tr>
								<td class="tdLabel">
				...
				<asp:Panel ID="pnlImportedRSSArticlesMain" runat="server" CssClass="settings_category_container edNews_numberedOptions">
					...
					<asp:Panel ID="pnlImportedRSSArticles" runat="server" CssClass="category_content">
						<table class="optionsList fullWidthTable strippedTable noBorder">
							...
							<tr>
								<td class="tdLabel">
									<label for="<%=cbAddCanonicalToOriginalRSSLink.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblAddCanonicalToOriginalRSSLink.HelpText", true) %>" data-tooltip-position="top-right"><%=_("lblAddCanonicalToOriginalRSSLink.Text") %></label>
								</td>
								<td>
									<div class="switchCheckbox">
										<asp:CheckBox CssClass="normalCheckBox" ID="cbAddCanonicalToOriginalRSSLink" runat="server" Text=" " />
									</div>
								</td>
							</tr>
							<tr>
				...
				<asp:Panel ID="pnlCanonicalURLsSettingsSource" runat="server" CssClass="settings_category_container edNews_numberedOptions">
					...
					<asp:Panel ID="pnlCanonicalURLsSettings" runat="server" CssClass="category_content">
						<table class="optionsList fullWidthTable strippedTable noBorder">
							...
							<tr>
								<td class="tdLabel">
									<label for="<%=ddlCanonicalLinksNewsInstance.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblCanonicalLinksNews.Help", true) %>" data-tooltip-position="top-right"><%=_("lblCanonicalLinksNews.Text") %></label>
								</td>
								<td>
									<asp:DropDownList ID="ddlCanonicalLinksNewsInstance" runat="server"></asp:DropDownList>
								</td>
							</tr>
							<tr>
								<td class="tdLabel">
									<label for="<%=cbCreateAMPArticles.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblCreateAMPArticles.Help", true) %>" data-tooltip-position="top-right"><%=_("lblCreateAMPArticles.Text") %></label>
								</td>
								<td>
									<div class="switchCheckbox">
										<asp:CheckBox CssClass="normalCheckBox" ID="cbCreateAMPArticles" runat="server" Enabled="True" Text=" " />
									</div>
								</td>
							</tr>
							<tr>
								<td class="tdLabel">
									<label for="<%=ddlAMPArticleTheme.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblAMPArticleTheme.HelpText", true) %>" data-tooltip-position="top-right"><%=_("lblAMPArticleTheme.Text") %></label>
								</td>
								<td>
									<asp:DropDownList ID="ddlAMPArticleTheme" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlAMPArticleTheme_SelectedIndexChanged" />
								</td>
							</tr>
							<tr>
								<td class="tdLabel">
									<label for="<%=ddlAMPArticleTemplate.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblAMPArticleTemplate.HelpText", true) %>" data-tooltip-position="top-right"><%=_("lblAMPArticleTemplate.Text") %></label>
								</td>
								<td>
									<asp:DropDownList ID="ddlAMPArticleTemplate" runat="server" />
									<asp:CustomValidator ID="cvddlAMPArticleTemplate" runat="server" ClientValidationFunction="AMPArticleTemplateValidation" Display="Dynamic" ErrorMessage="Please select template." ValidationGroup="vgSettings"></asp:CustomValidator>
									<asp:Label ID="lblAMPArticleTemplateError" ResourceKey="lblAMPArticleTemplateError" runat="server" CssClass="smallInfo error" Text="You must select template to enable AMP articles." Visible="false" />
								</td>
							</tr>
							<tr>
								<td class="tdLabel">
									<label for="<%=btnDeleteCreatedAMPArticles.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblDeleteCreatedAMPArticles.HelpText", true) %>" data-tooltip-position="top-right"><%=_("lblDeleteCreatedAMPArticles.Text") %></label>
								</td>
								<td>
									<div class="mainActions smallActions displayInline noMargin">
										<asp:Button ID="btnDeleteCreatedAMPArticles" resourcekey="btnDeleteCreatedAMPArticles" runat="server" Text="Delete" CssClass="delete" OnClick="btnDeleteCreatedAMPArticles_Click" />
									</div>
									<label runat="server" id="lblDeleteCreatedAMPPagesMessages" enableviewstate="false"></label>
								</td>
							</tr>
						</table>
					</asp:Panel>
				</asp:Panel>
				<asp:Panel ID="pnlMetaAndStructuredDataSettingsSource" runat="server" CssClass="settings_category_container edNews_numberedOptions">
					<asp:HiddenField ID="hfMetaAndStructuredDatas" runat="server" Value="edNews__collapsed" />
					<div class="category_toggle edNews_numberedOptionsHeader">
						<div class="edNews_inputGroup displayInline">
							<asp:RadioButtonList ID="rblMetaAndStructuredDataSettings" runat="server" AutoPostBack="true" CssClass="inlineList styledRadio" RepeatLayout="UnorderedList" OnSelectedIndexChanged="rblMetaAndStructuredDataSettings_SelectedIndexChanged">
								<asp:ListItem class="normalRadioButton" Value="Portal" Selected="True" resourcekey="liDefaultSettings" Text="Default settings" />
								<asp:ListItem class="normalRadioButton" Value="Instance" resourcekey="liModuleSettings" Text="Module instance (override default)" />
							</asp:RadioButtonList>
						</div>
						<span class="edNews_numberedOptionsHeaderNumber">21</span>
						<h2><%=_("MetaAndStructuredDataSettingsHeader.Text", true) %></h2>
					</div>
					<asp:Panel ID="pnlMetaAndStructuredDataSettings" runat="server" CssClass="category_content">
						<div class="sectionBoxSubtitle highlighted3">
							<asp:Label ID="lblOpenGraphTitle" resourcekey="lblOpenGraphTitle" runat="server" Text="Open Graph" />
						</div>
						<table class="optionsList fullWidthTable strippedTable noBorder">
							<tr>
								<td class="tdLabel">
									<label for="<%=cbEnableOpenGraph.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblEnableOpenGraph.Help", true) %>" data-tooltip-position="top-right"><%=_("lblEnableOpenGraph.Text") %></label>
								</td>
								<td>
									<div class="switchCheckbox">
										<asp:CheckBox CssClass="normalCheckBox" ID="cbEnableOpenGraph" runat="server" Enabled="True" Text=" " Checked="True" />
									</div>
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td class="tdLabel">
									<label for="<%=cbEnableOpenGraphTemplateSelection.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblEnableOpenGraphTemplateSelection.Help", true) %>" data-tooltip-position="top-right"><%=_("lblEnableOpenGraphTemplateSelection.Text") %></label>
								</td>
								<td>
									<div class="switchCheckbox">
										<asp:CheckBox CssClass="normalCheckBox" ID="cbEnableOpenGraphTemplateSelection" runat="server" Enabled="True" Text=" " />
									</div>
								</td>
							</tr>
						</table>
						<div class="sectionBoxSubtitle highlighted3">
							<asp:Label ID="lblTwitterCardsTitle" resourcekey="lblTwitterCardsTitle" runat="server" Text="Twitter Cards" />
						</div>
						<table class="optionsList fullWidthTable strippedTable noBorder">
							<tr>
								<td class="tdLabel">
									<label for="<%=cbEnableTwitterCards.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblEnableTwitterCards.Help", true) %>" data-tooltip-position="top-right"><%=_("lblEnableTwitterCards.Text") %></label>
								</td>
								<td>
									<div class="switchCheckbox">
										<asp:CheckBox CssClass="normalCheckBox" ID="cbEnableTwitterCards" runat="server" Enabled="True" Text=" " Checked="True" />
									</div>
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td class="tdLabel">
									<label for="<%=cbEnableTwitterCardsTemplateSelection.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblEnableTwitterCardsTemplateSelection.Help", true) %>" data-tooltip-position="top-right"><%=_("lblEnableTwitterCardsTemplateSelection.Text") %></label>
								</td>
								<td>
									<div class="switchCheckbox">
										<asp:CheckBox CssClass="normalCheckBox" ID="cbEnableTwitterCardsTemplateSelection" runat="server" Enabled="True" Text=" " />
									</div>
								</td>
							</tr>
						</table>
						<div class="sectionBoxSubtitle highlighted3">
							<asp:Label ID="lblStructuredDataTitle" resourcekey="lblStructuredDataTitle" runat="server" Text="Structured Data" />
						</div>
						<table class="optionsList fullWidthTable strippedTable noBorder">
							<tr>
								<td class="tdLabel">
									<label for="<%=cbEnableStructuredData.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblEnableStructuredData.Help", true) %>" data-tooltip-position="top-right"><%=_("lblEnableStructuredData.Text") %></label>
								</td>
								<td>
									<div class="switchCheckbox">
										<asp:CheckBox CssClass="normalCheckBox" ID="cbEnableStructuredData" runat="server" Enabled="True" Text=" " />
									</div>
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td class="tdLabel">
									<label for="<%=cbEnableStructuredDataTemplateSelection.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblEnableStructuredDataTemplateSelection.Help", true) %>" data-tooltip-position="top-right"><%=_("lblEnableStructuredDataTemplateSelection.Text") %></label>
								</td>
								<td>
									<div class="switchCheckbox">
										<asp:CheckBox CssClass="normalCheckBox" ID="cbEnableStructuredDataTemplateSelection" runat="server" Enabled="True" Text=" " />
									</div>
								</td>
							</tr>
						</table>
				...
				<asp:Panel ID="pnlGoogleMapsSettings" runat="server" CssClass="settings_category_container edNews_numberedOptions">
					...
					<div class="category_toggle edNews_numberedOptionsHeader">
						...
						<span class="edNews_numberedOptionsHeaderNumber">23</span>
					...
					<asp:Panel ID="pnlGoogleMapsSettingsSourceTable" runat="server" CssClass="category_content">
						<table class="optionsList fullWidthTable strippedTable noBorder">
							...
							<tr>
								<td class="tdLabel width50">
									<label for="<%=cbForceMapsSettings.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblForceMapsSettings.HelpText", true) %>" data-tooltip-position="top-right"><%=_("lblForceMapsSettings.Text") %></label>
								</td>
								<td>
									<div class="switchCheckbox">
										<asp:CheckBox CssClass="normalCheckBox" ID="cbForceMapsSettings" runat="server" Checked="False" Text=" " />
									</div>
								</td>
							</tr>
							<tr>
								<td class="tdLabel">
									<label for="<%=ddlMapsDefaultType.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblddlMapsDefaultType.HelpText", true) %>" data-tooltip-position="top-right"><%=_("lblddlMapsDefaultType.Text") %></label>
								</td>
								<td>
									<asp:DropDownList ID="ddlMapsDefaultType" runat="server">
										<asp:ListItem Value="ROADMAP">Roadmap</asp:ListItem>
							...
							<tr>
								<td class="tdLabel">
									<label for="<%=tbForceMapsWidth.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblForceMapsWidth.HelpText", true) %>" data-tooltip-position="top-right"><%=_("lblForceMapsWidth.Text") %></label>
								</td>
								<td>
									<asp:TextBox ID="tbForceMapsWidth" runat="server" CssClass="smallCentered" Text="400" />
									<asp:RequiredFieldValidator ID="rfvForceMapsWidth" runat="server" ControlToValidate="tbForceMapsWidth" ErrorMessage="This filed is required." ValidationGroup="vgSettings" resourcekey="rfvNumberOfPostsResource1.ErrorMessage" />
									<asp:RangeValidator ID="rvForceMapsWidth"
										ControlToValidate="tbForceMapsWidth"
										MinimumValue="1"
										MaximumValue="5000"
										Type="Integer"
										Text="The value must be integer and greater or equal than 1"
							...
							<tr>
								<td class="tdLabel">
									<label for="<%=tbForceMapsHeight.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblForceMapsHeight.HelpText", true) %>" data-tooltip-position="top-right"><%=_("lblForceMapsHeight.Text") %></label>
								</td>
								<td>
									<asp:TextBox ID="tbForceMapsHeight" runat="server" CssClass="smallCentered" Text="300" />
									<asp:RequiredFieldValidator ID="rfvForceMapsHeight" runat="server" ControlToValidate="tbForceMapsHeight" ErrorMessage="This filed is required." ValidationGroup="vgSettings" resourcekey="rfvNumberOfPostsResource1.ErrorMessage" />
									<asp:RangeValidator ID="rvForceMapsHeight"
										ControlToValidate="tbForceMapsHeight"
										MinimumValue="1"
										MaximumValue="5000"
										Type="Integer"
										Text="The value must be integer and greater or equal than 1"
				...
				<asp:Panel ID="pnlAdvancedModuleMain" runat="server" CssClass="settings_category_container edNews_numberedOptions">
					<asp:HiddenField ID="hfAdvancedModuleState" runat="server" Value="edNews__collapsed" />
					<div class="category_toggle edNews_numberedOptionsHeader">
						<div class="edNews_inputGroup displayInline">
							<label runat="server"><%=_("lblModuleOnly.Text") %></label>
						</div>
						<span class="edNews_numberedOptionsHeaderNumber">24</span>
						<h2><%=_("lblAdvancedModuleSettings.Text")%></h2>
					</div>
					<asp:Panel ID="pnlAdvancedModuleSettingsSourceTable" runat="server" CssClass="category_content">
						<table class="optionsList fullWidthTable strippedTable noBorder">
							<tr>
								<td class="tdLabel">
									<label for="<%=cbEnableWebAPi.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("cbEnableWebAPi.HelpText", true) %>" data-tooltip-position="top-right"><%=_("cbEnableWebAPi.Text") %></label>
								</td>
								<td>
									<div class="switchCheckbox edNews__toggleNext2TableRow">
										<asp:CheckBox CssClass="normalCheckBox" ID="cbEnableWebAPi" runat="server" Text=" " />
									</div>
								</td>
							</tr>
							<tr>
								<td class="tdLabel">
									<label for="<%=lblModuleAPIKey.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("tbModuleAPIKey.HelpText", true) %>" data-tooltip-position="top-right"><%=_("tbModuleAPIKey.Text") %></label>
								</td>
								<td>
									<asp:Label ID="lblModuleAPIKey" runat="server" Width="350px" Text="" Enabled="True" />
								</td>
							</tr>
							<tr>
								<td class="tdLabel">
									<label for="<%=hlWebApiLink.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblWebApiLink.HelpText", true) %>" data-tooltip-position="top-right"><%=_("lblWebApiLink.Text") %></label>
								</td>
								<td>
									<asp:HyperLink runat="server" ID="hlWebApiLink" Target="_blank"></asp:HyperLink>
								</td>
							</tr>
						</table>
					</asp:Panel>
				</asp:Panel>
				<asp:Panel ID="pnlAdsIntegrationSettingsSource" runat="server" CssClass="settings_category_container edNews_numberedOptions">
					<asp:HiddenField ID="hfAdsIntegration" runat="server" Value="edNews__collapsed" />
					<div class="category_toggle edNews_numberedOptionsHeader">
						<div class="edNews_inputGroup displayInline">
							<asp:RadioButtonList ID="rblAdsIntegrationSettings" runat="server" AutoPostBack="true" CssClass="inlineList styledRadio" RepeatLayout="UnorderedList" OnSelectedIndexChanged="rblAdsIntegrationSettings_SelectedIndexChanged">
								<asp:ListItem class="normalRadioButton" Value="Portal" Selected="True" resourcekey="liDefaultSettings" Text="Default settings" />
								<asp:ListItem class="normalRadioButton" Value="Instance" resourcekey="liModuleSettings" Text="Module instance (override default)" />
							</asp:RadioButtonList>
						</div>
						<span class="edNews_numberedOptionsHeaderNumber">25</span>
						<h2><%=_("AdsIntegrationSettings.Text")%></h2>
					</div>
					<asp:Panel ID="pnlAdsIntegrationSettings" runat="server" CssClass="category_content">
						<table class="optionsList fullWidthTable strippedTable noBorder">
							<tr>
								<td class="tdLabel">
									<label for="<%=cbEnableAdsIntegration.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblEnableAdsIntegration.HelpText", true) %>" data-tooltip-position="top-right"><%=_("lblEnableAdsIntegration.Text") %></label>
								</td>
								<td>
									<div class="switchCheckbox edNews__toggleNextSiblings">
										<asp:CheckBox CssClass="normalCheckBox" ID="cbEnableAdsIntegration" runat="server" Text=" " />
									</div>
								</td>
							</tr>
							<tr>
								<td class="tdLabel">
									<label for="<%=tbInArticlePositionParagraph.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblInArticlePositionParagraph.Help", true) %>" data-tooltip-position="top-right"><%=_("lblInArticlePositionParagraph.Text") %></label>
								</td>
								<td>
									<asp:TextBox ID="tbInArticlePositionParagraph" runat="server" CssClass="smallCentered" Text="3" />
									<asp:RequiredFieldValidator ID="rfvInArticlePositionParagraph" runat="server" ControlToValidate="tbInArticlePositionParagraph" ErrorMessage="This filed is required." ValidationGroup="vgSettings" resourcekey="rfvNumberOfPostsResource1.ErrorMessage" />
									<asp:RangeValidator ID="rvInArticlePositionParagraph"
										ControlToValidate="tbInArticlePositionParagraph"
										MinimumValue="1"
										MaximumValue="100"
										Type="Integer"
										Text="The value must be integer and greater or equal than 1"
							...
							<tr>
								<td class="tdLabel">
									<label for="<%=cbInArticlePositionRepeat.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblInArticlePositionRepeat.HelpText", true) %>" data-tooltip-position="top-right"><%=_("lblInArticlePositionRepeat.Text") %></label>
								</td>
								<td>
									<div class="switchCheckbox">
										<asp:CheckBox CssClass="normalCheckBox" ID="cbInArticlePositionRepeat" runat="server" Text=" " />
									</div>
								</td>
							</tr>
							<tr>
								<td class="tdLabel">
									<label for="<%=ddlBannerSource.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblBannerSource.HelpText", true) %>" data-tooltip-position="top-right"><%=_("lblBannerSource.Text") %></label>
								</td>
								<td>
									<asp:DropDownList ID="ddlBannerSource" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlBannerSource_SelectedIndexChanged">
										<asp:ListItem resourcekey="liPortal" Value="0">Portal</asp:ListItem>
										<asp:ListItem resourcekey="liHost" Value="1">Host</asp:ListItem>
									</asp:DropDownList>
								</td>
							</tr>
							<tr>
								<td class="tdLabel">
									<label for="<%=ddlBannerType.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblBannerType.HelpText", true) %>" data-tooltip-position="top-right"><%=_("lblBannerType.Text") %></label>
								</td>
								<td>
									<asp:DropDownList ID="ddlBannerType" runat="server">
										<asp:ListItem resourcekey="liBanner" Value="0">Banner</asp:ListItem>
										<asp:ListItem resourcekey="liMicroButton" Value="1">MicroButton</asp:ListItem>
										<asp:ListItem resourcekey="liButton" Value="2">Button</asp:ListItem>
										<asp:ListItem resourcekey="liBlock" Value="3">Block</asp:ListItem>
										<asp:ListItem resourcekey="liScript" Value="4">Script</asp:ListItem>
										<asp:ListItem resourcekey="liText" Value="5">Text</asp:ListItem>
									</asp:DropDownList>
								</td>
							</tr>
							<tr>
								<td class="tdLabel">
									<label for="<%=ddlSelectBannerGroup.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblSelectBannerGroup.HelpText", true) %>" data-tooltip-position="top-right"><%=_("lblSelectBannerGroup.Text") %></label>
								</td>
								<td>
									<asp:DropDownList ID="ddlSelectBannerGroup" runat="server">
									</asp:DropDownList>
								</td>
							</tr>
						</table>
