...
<asp:HiddenField ID="hfAlreadyPublushed" runat="server" Value="False" />
<asp:Panel ID="pnlMainWrapper" runat="server">
	<asp:Panel ID="pnlEditArticle" runat="server" CssClass="edNews_adminWrapper mainContentWrapper topPadded bottomPadded">
		<div id="EDNadmin" class="contentSection">
			...
			<asp:Panel ID="pnlImagelocalization" CssClass="main_content topPadded edNews_loaderWrapper" runat="server" Visible="false">
				<div class="edNews_loader">
					<div></div>
				</div>
				<asp:HiddenField ID="hfImageLocaPicID" runat="server" />
				<div class="negativeMargins">
					<table class="optionsList fullWidthTable strippedTable noBorder" cellpadding="0" cellspacing="0">
						<tr>
				...
				<div class="text_input_set overflow_visible">
					...
					<div class="mainActions smallActions noMargin floatRight">
						<asp:LinkButton ID="btnContentLocalizationGenerateAI" OnClientClick="openImageLocalizationPreloader();" CssClass="primaryAction" runat="server" OnClick="btnContentLocalizationGenerateAI_Click" resourcekey="btnContentLocalizationGenerateAI" />
						<asp:LinkButton ID="btnContentLocalizationCopyDefault" CssClass="primaryAction" runat="server" OnClick="btnContentLocalizationCopyDefault_Click" resourcekey="lbCLCopyDefaultsResource1" />
					</div>
				</div>
				<div class="text_input_set overflow_visible">
				...
				<div class="mainActions">
					<asp:LinkButton ID="btnContentLocalizationUpdate" CssClass="downSave" runat="server" OnClick="btnImageEditorContentLocalizationUpdate_Click"><%=Savelocalization%></asp:LinkButton>
					<asp:LinkButton ID="btnContentLocalizationClose" CssClass="cancel" runat="server" OnClick="btnContentLocalizationClose_Click"><%=Close%></asp:LinkButton>
				</div>
			</asp:Panel>
			<asp:Panel ID="pnlContentLocalizationDetails" CssClass="main_content topPadded edNews_loaderWrapper" runat="server" Visible="false">
				<div class="edNews_loader">
					<div></div>
				</div>
				<div class="negativeMargins">
					<table class="optionsList fullWidthTable strippedTable noBorder">
						...
						<tr>
							<td class="tdLabel textTop">
								<strong>
									<asp:Label ID="lblNotLocalizedLanguagesHelp" runat="server" resourcekey="lblNotLocalizedLanguagesHelp" Text="Not localized languages for this article:" /></strong>
							</td>
							<td>
			...
			<asp:Panel ID="pnlMainEdit" runat="server" CssClass="main_content">
				...
				<div id="pnlSEO" runat="server" class="collapsible_box">
					<h1 class="collapsible_box_title">
						<%=SEOsettings%></h1>
					<div class="content eds_Tabs eds_whiteTabs" id="collapsible_seo_box_content" runat="server">
						<asp:UpdatePanel ID="upSeoSettings" runat="server" UpdateMode="Conditional" OnUnload="UpdatePanel_Unload">
							<ContentTemplate>
								<div class="edn_admin_progress_overlay_container">
									<asp:UpdateProgress ID="UpdateProgress1" runat="server" AssociatedUpdatePanelID="upSeoSettings" DisplayAfter="100" DynamicLayout="true">
										<ProgressTemplate>
											<div class="edn_admin_progress_overlay">
											</div>
										</ProgressTemplate>
									</asp:UpdateProgress>
									<div class="edsTabulator">
										<ul class="eds_tabsNav">
											<li class="edsTabGeneral edsTabulator_tabTrigger"><%=_("General.Text") %></li>
											<li class="edsTabOpenGraph edsTabulator_tabTrigger"><%=_("OpenGraph.Text") %></li>
											<li class="edsTabTwitterCards edsTabulator_tabTrigger"><%=_("TwitterCards.Text") %></li>
											<li class="edsTabStructuredData edsTabulator_tabTrigger"><%=_("StructuredData.Text") %></li>
										</ul>
										<div class="edsTabulator_tabsWrapper">
											<div class="edsTabulator_tab">
												...
												<div class="text_input_set">
													<label for="<%=ddlAddRobotsFollowTag.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("cbAddNoFollowTag.HelpText", true) %>" data-tooltip-position="top-right"><%=_("cbAddNoFollowTag.Text") %></label>
													...
													<div class="mainActions smallActions noMargin floatRight">
														<div class="edNews_dropdownchecklistWrapper edNews_AIseoOptions">
															<asp:ListBox ID="lbGenerateAISEOOptions" runat="server" SelectionMode="Multiple" Visible="False">
																<asp:ListItem resourcekey="liAllFields" Value="liAllFields" Text="All Fields" Selected="True" />
																<asp:ListItem resourcekey="liTitleTag" Value="liTitleTag" Text="Title tag" />
																<asp:ListItem resourcekey="liMetaDescription" Value="liMetaDescription" Text="Meta description" />
																<asp:ListItem resourcekey="liMetaKeywords" Value="liMetaKeywords" Text="Meta keywords" />
															</asp:ListBox>
														</div>
														<asp:LinkButton ID="lbGenerateAISEO" CssClass="primaryAction" runat="server" OnClick="lbGenerateAISEO_Click" resourcekey="lbGenerateAISEO" Text="Generate AI SEO" Visible="False" />
													</div>
												</div>
											</div>
											<div class="edsTabulator_tab text_input_set overflow_visible">
												<asp:Panel ID="pnlOpenGraphMetaTagsTemplateSelection" runat="server" CssClass="edNews_seoTemplates" Visible="false">
													<label for="<%=ddlOpenGraphTemplate.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblOpenGraphTemplate.HelpText", true) %>" data-tooltip-position="top-right"><%=_("lblOpenGraphTemplate.Text") %></label>
													<asp:DropDownList ID="ddlOpenGraphTemplate" runat="server" />
												</asp:Panel>
												<label for="<%=tbOpenGraphMetaTags.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblOpenGraphMetaTags.HelpText", true) %>" data-tooltip-position="top-left"><%=_("lblOpenGraphMetaTags.Text") %></label>
												<asp:TextBox ID="tbOpenGraphMetaTags" runat="server" CssClass="text" Style="height: 200px;" MaxLength="4000" TextMode="MultiLine"></asp:TextBox>
											</div>
											<div class="edsTabulator_tab text_input_set overflow_visible">
												<asp:Panel ID="pnlTwitterCardsTemplateSelection" runat="server" CssClass="edNews_seoTemplates" Visible="false">
													<label for="<%=ddlTwitterCardsTemplate.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblTwitterCardsTemplate.HelpText", true) %>" data-tooltip-position="top-right"><%=_("lblTwitterCardsTemplate.Text") %></label>
													<asp:DropDownList ID="ddlTwitterCardsTemplate" runat="server" />
												</asp:Panel>
												<label for="<%=tbTwitterCardMetaTags.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblTwitterCardsMetaTags.HelpText", true) %>" data-tooltip-position="top-left"><%=_("lblTwitterCardsMetaTags.Text") %></label>
												<asp:TextBox ID="tbTwitterCardMetaTags" runat="server" CssClass="text" Style="height: 200px;" MaxLength="4000" TextMode="MultiLine"></asp:TextBox>
											</div>
											<div class="edsTabulator_tab text_input_set overflow_visible">
												<asp:Panel ID="pnlStructuredDataTemplateSelection" runat="server" CssClass="edNews_seoTemplates" Visible="false">
													<label for="<%=ddlStructuredDataTemplate.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblStructuredDataTemplate.HelpText", true) %>" data-tooltip-position="top-right"><%=_("lblStructuredDataTemplate.Text") %></label>
													<asp:DropDownList ID="ddlStructuredDataTemplate" runat="server" />
												</asp:Panel>
												<label for="<%=tbStructuredDataJSON.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblStructuredDataJson.HelpText", true) %>" data-tooltip-position="top-left"><%=_("lblStructuredDataJson.Text") %></label>
												<asp:TextBox ID="tbStructuredDataJSON" runat="server" CssClass="text" Style="height: 400px;" MaxLength="4000" TextMode="MultiLine"></asp:TextBox>
												<asp:CustomValidator ID="cvStructuredDataJSON" CssClass="EDN_error" runat="server" ClientValidationFunction="ClientValidateStructuredDataTemplate" Display="Dynamic" ErrorMessage="Invalid data. Please replace Placeholder values with real data." resourcekey="cvStructuredDataJSON.ErrorMessage" ValidationGroup="vgEditArticle" ControlToValidate="tbStructuredDataJSON" SetFocusOnError="True"></asp:CustomValidator>
											</div>
										</div>
									</div>
								</div>
				...
				<div id="pnlDetailTypePanels" runat="server" class="section_box white_border_1" style="border-top: 0; margin: 0; padding: 15px;">
					<asp:Panel ID="pnlDetailTypeText" CssClass="text_input_set edNews_textEditorDetails detailshtmleditor" runat="server">
						<div class="contenthtmleditor openAiArticleWrapper" runat="server" id="divOpenIdArticleGenerator" visible="false">
							<span id="edn_divOpenIdArticleGeneratorlTrigger" onclick="initOpenAiArticleGenerate();" class="eds_openModal rounded_button gradient olive_green icon orange_plus" data-target-id="<%=pnlOPeanAIGenerateArticleWindow.ClientID  %>"><span><%=_("GenerateArticlewithAI.Text") %></span></span>
						</div>
						...
						<asp:Panel ID="pnlOPeanAIGenerateArticleWindow" runat="server" CssClass="eds_modalWrapper eds_resizable eds_width70" Visible="True">
							<div class="eds_modalContent eds_animated">
								<h3>
									<asp:Label ID="lblGenerateArticeleTextTitle" resourcekey="lblGenerateArticeleTextTitle" runat="server" />
								</h3>
								<div>
									<div style="overflow: auto; max-height: 700px;">
										<div style="display: block">
											<div id="eds__generateAIArticleMainWrapper" style="display: block">
												<div class="eds_labelAndInput eds_labelAndInput">
													<asp:Label ID="lblAIGenerateArticleLanguage" resourcekey="lblAIGenerateArticleLanguage" runat="server" AssociatedControlID="ddlAIGenerateArticleLanguage" Style="width: 240px"></asp:Label>
													<asp:DropDownList ID="ddlAIGenerateArticleLanguage" runat="server">
													</asp:DropDownList>
												</div>
												<div class="eds_labelAndInput">
													<asp:Label ID="lblAIGenerateArticleStyle" resourcekey="lblAIGenerateArticleStyle" runat="server" AssociatedControlID="ddlAIGenerateArticleStyle" Style="width: 240px"></asp:Label>
													<asp:DropDownList ID="ddlAIGenerateArticleStyle" runat="server">
														<asp:ListItem resourcekey="liNormal" Value="liNormal" Text="Normal" />
														<asp:ListItem resourcekey="liPersuasive" Value="liPersuasive" Text="Persuasive" />
														<asp:ListItem resourcekey="liInformative" Value="liInformative" Text="Informative" />
														<asp:ListItem resourcekey="liDescriptive" Value="liDescriptive" Text="Descriptive" />
														<asp:ListItem resourcekey="liCreative" Value="liCreative" Text="Creative" />
														<asp:ListItem resourcekey="liNarrative" Value="liNarrative" Text="Narrative" />
														<asp:ListItem resourcekey="liArgumentative" Value="liArgumentative" Text="Argumentative" />
														<asp:ListItem resourcekey="liAnalytical" Value="liAnalytical" Text="Analytical" />
														<asp:ListItem resourcekey="liEvaluative" Value="liEvaluative" Text="Evaluative" />
													</asp:DropDownList>
												</div>
												<div class="eds_labelAndInput">
													<asp:Label ID="lblTextToGenerateArticle" resourcekey="lblTextToGenerateArticle" runat="server" AssociatedControlID="tbTextToGenerateArticle"></asp:Label>
													<asp:TextBox ID="tbTextToGenerateArticle" runat="server" CssClass="text" Text="" TextMode="MultiLine" />
													<asp:RequiredFieldValidator ID="rfvTextToGenerateArticle" runat="server" ControlToValidate="tbTextToGenerateArticle" ErrorMessage="Please enter text." ValidationGroup="vgGenerateArticeleTextTitle" Display="Dynamic" />
												</div>
												<div class="edn_bottomButtonWrapper">
													<asp:Button ID="btnGenerateArticeleTextTitle" runat="server" Text="Generate Article with OpenAI" ValidationGroup="vgGenerateArticeleTextTitle" CssClass="submit" OnClientClick="GenerateAIArticle(); return false;" />
												</div>
											</div>
											<div id="eds__generatedArticleTextWrapper" style="display: none">
												<div class="eds_labelAndInput eds_labelWidth100">
													<asp:Label ID="lblAIGeneratedArticleTitle" resourcekey="lblAIGeneratedArticleTitle" runat="server" AssociatedControlID="tbAIGeneratedArticleTitle"></asp:Label>
													<div class="eds_flexGroup">
														<div class="eds_flexInput">
															<asp:TextBox ID="tbAIGeneratedArticleTitle" runat="server" CssClass="text tbAIGeneratedArticle" Text="" Enabled="True" />
														</div>
														<div>
															<asp:RadioButtonList ID="rblReplaceGeneratedArticleTitle" runat="server" CssClass="styledRadio inlineList smallRadio" RepeatLayout="UnorderedList">
																<asp:ListItem class="normalRadioButton" resourcekey="liReplace" Value="Replace">Replace</asp:ListItem>
																<asp:ListItem class="normalRadioButton" resourcekey="liAppend" Selected="True" Value="Append">Append</asp:ListItem>
																<asp:ListItem class="normalRadioButton" resourcekey="liNoAction" Value="None">No action</asp:ListItem>
															</asp:RadioButtonList>
														</div>
													</div>
												</div>
												<div class="eds_labelAndInput eds_labelWidth100">
													<asp:Label ID="lblAIGeneratedArticleSubtitle" resourcekey="lblAIGeneratedArticleSubtitle" runat="server" AssociatedControlID="tbAIGeneratedArticleSubtitle"></asp:Label>
													<div class="eds_flexGroup">
														<div class="eds_flexInput">
															<asp:TextBox ID="tbAIGeneratedArticleSubtitle" runat="server" CssClass="text tbAIGeneratedArticle" Text="" Enabled="True" />
														</div>
														<div>
															<asp:RadioButtonList ID="rblAIGeneratedArticleSubtitle" runat="server" CssClass="styledRadio inlineList smallRadio" RepeatLayout="UnorderedList">
																<asp:ListItem class="normalRadioButton" resourcekey="liReplace" Value="Replace">Replace</asp:ListItem>
																<asp:ListItem class="normalRadioButton" resourcekey="liAppend" Selected="True" Value="Append">Append</asp:ListItem>
																<asp:ListItem class="normalRadioButton" resourcekey="liNoAction" Value="None">No action</asp:ListItem>
															</asp:RadioButtonList>
												...
												<div class="eds_labelAndInput eds_labelWidth100">
													<asp:Label ID="lblAIGeneratedArticle" resourcekey="lblAIGeneratedArticle" runat="server" AssociatedControlID="tbAIGeneratedArticle"></asp:Label>
													<div class="eds_flexGroup">
														<div class="eds_flexInput">
															<asp:TextBox ID="tbAIGeneratedArticle" runat="server" CssClass="text tbAIGeneratedArticle" Text="" TextMode="MultiLine" Enabled="True" />
														</div>
														<div>
															<asp:RadioButtonList ID="rblReplaceGeneratedArticle" runat="server" CssClass="styledRadio inlineList smallRadio" RepeatLayout="UnorderedList">
																<asp:ListItem class="normalRadioButton" resourcekey="liReplace" Value="Replace">Replace</asp:ListItem>
																<asp:ListItem class="normalRadioButton" resourcekey="liAppend" Selected="True" Value="Append">Append</asp:ListItem>
																<asp:ListItem class="normalRadioButton" resourcekey="liNoAction" Value="None">No action</asp:ListItem>
															</asp:RadioButtonList>
												...
												<div class="eds_labelAndInput eds_labelWidth100">
													<asp:Label ID="lblAIGeneratedArticleSummary" resourcekey="lblAIGeneratedArticleSummary" runat="server" AssociatedControlID="tbAIGeneratedArticleSummary"></asp:Label>
													<div class="eds_flexGroup">
														<div class="eds_flexInput">
															<asp:TextBox ID="tbAIGeneratedArticleSummary" runat="server" CssClass="text tbAIGeneratedArticleSummary" Text="" TextMode="MultiLine" Enabled="True" />
														</div>
														<div>
															<asp:RadioButtonList ID="rblAIGeneratedArticleSummary" runat="server" CssClass="styledRadio inlineList smallRadio" RepeatLayout="UnorderedList">
																<asp:ListItem class="normalRadioButton" resourcekey="liReplace" Value="Replace">Replace</asp:ListItem>
																<asp:ListItem class="normalRadioButton" resourcekey="liAppend" Selected="True" Value="Append">Append</asp:ListItem>
																<asp:ListItem class="normalRadioButton" resourcekey="liNoAction" Value="None">No action</asp:ListItem>
															</asp:RadioButtonList>
												...
												<div class="eds_labelAndInput eds_labelWidth100">
													<asp:Label ID="lblAIGeneratedArticleTags" resourcekey="lblAIGeneratedArticleTags" runat="server" AssociatedControlID="tbAIGeneratedArticleTags"></asp:Label>
													<div class="eds_flexGroup">
														<div class="eds_flexInput">
															<asp:TextBox ID="tbAIGeneratedArticleTags" runat="server" CssClass="text tbAIGeneratedArticle" Text="" Enabled="True" />
														</div>
														<div>
															<asp:RadioButtonList ID="rblAIGeneratedArticleTags" runat="server" CssClass="styledRadio inlineList smallRadio" RepeatLayout="UnorderedList">
																<asp:ListItem class="normalRadioButton" resourcekey="liReplace" Value="Replace">Replace</asp:ListItem>
																<asp:ListItem class="normalRadioButton" resourcekey="liAppend" Selected="True" Value="Append">Append</asp:ListItem>
																<asp:ListItem class="normalRadioButton" resourcekey="liNoAction" Value="None">No action</asp:ListItem>
															</asp:RadioButtonList>
															<div class="edn_bottomButtonWrapper eds_alignCenter">
																<asp:Button ID="btnUseGenerateArticeleText" resourcekey="btnUseGenerateArticeleText" runat="server" Text="Copy Article" CssClass="submit" OnClick="btnUseGenerateArticeleText_Click" />
															</div>
														</div>
													</div>
												</div>
								...
								<span class="eds_modalClose eds_closeWindowButtonOuter" data-target-id='<%=pnlOPeanAIGenerateArticleWindow.ClientID%>'>x</span>
							</div>
						</asp:Panel>
					</asp:Panel>
								...
								<div class="content main_article_image">
									...
									<div class="right_col">
										<div style="padding-top: 20px;">
											...
											<div id="rblSelectListMainImageEmbedTypeDiv" runat="server" visible="false" class="edNews_inputGroup displayInline" style="margin-left: 15px;">
												<asp:RadioButtonList ID="rblSelectListMainImageEmbedType" runat="server" CssClass="styledRadio inlineList smallRadio" RepeatLayout="UnorderedList">
										...
										<asp:Panel ID="pnlGallerySettings" runat="server" Style="display: none;">
												...
												<tr>
													...
													<td class="right">
														<asp:DropDownList ID="ddlGalleryDisplayType" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlGalleryDisplayType_SelectedIndexChanged">
															...
															<asp:ListItem Value="zerogravity">Zero Gravity gallery</asp:ListItem>
														</asp:DropDownList>
													</td>
												</tr>
											</table>
												...
												<table class="settings_table">
													<tr>
														...
														<td class="right">
															...
															<asp:RequiredFieldValidator ID="rfvRhumbImageWidth" runat="server" ControlToValidate="tbxGalleryWidth" ErrorMessage="This filed is required." SetFocusOnError="True" ValidationGroup="vgEditArticle" resourcekey="rfvRhumbImageWidth0Resource1" Display="Dynamic" />
															<asp:CompareValidator ID="cvtbxGalleryWidth" runat="server" ControlToValidate="tbxGalleryWidth" Display="Dynamic" ErrorMessage="Please enter number only." Operator="DataTypeCheck" Type="Integer" ValidationGroup="vgEditArticle" resourcekey="cvLightBoxGalleryNumberOfItemsResource1"
																SetFocusOnError="True" />
															<asp:RangeValidator ID="rvtbxGalleryWidth" runat="server" ControlToValidate="tbxGalleryWidth" Display="Dynamic" Enabled="false" ErrorMessage="Enter value between 0-100." MaximumValue="100" MinimumValue="0" resourcekey="rvChameleonWidthPerct.ErrorMessage"
													...
													<tr>
														...
														<td class="right">
															...
															<asp:DropDownList ID="ddlChameleonGalleryHeightType" runat="server" Visible="False" AutoPostBack="True" OnSelectedIndexChanged="ddlChameleonGalleryHeightType_SelectedIndexChanged">
																<asp:ListItem Value="0">px</asp:ListItem>
																<asp:ListItem Value="1">%</asp:ListItem>
															</asp:DropDownList>
															<asp:RequiredFieldValidator ID="rfvtbxGalleryHeight" runat="server" ControlToValidate="tbxGalleryHeight" ErrorMessage="This filed is required." SetFocusOnError="True" ValidationGroup="vgEditArticle" resourcekey="rfvRhumbImageWidth1Resource1.ErrorMessage"
																Display="Dynamic" />
															<asp:CompareValidator ID="cvtbxGalleryHeight" runat="server" ControlToValidate="tbxGalleryHeight" Display="Dynamic" ErrorMessage="Please enter number only." Operator="DataTypeCheck" Type="Integer" ValidationGroup="vgEditArticle" resourcekey="cvLightBoxGalleryNumberOfItems0Resource1.ErrorMessage" SetFocusOnError="True" />
															<asp:RangeValidator ID="rvtbxGalleryHeight" runat="server" ControlToValidate="tbxGalleryHeight" Display="Dynamic" Enabled="False" ErrorMessage="Enter value between 0-100." MaximumValue="100" MinimumValue="0" resourcekey="rvtbxGalleryHeight.ErrorMessage" SetFocusOnError="True" Type="Integer" ValidationGroup="vgEditArticle" CssClass="smallInfo warning"></asp:RangeValidator>
														</td>
													</tr>
													<tr id="trChameleonResponsiveMainImageWidth" runat="server">
														...
														<td class="right">
															...
															<asp:RequiredFieldValidator ID="rfvtbxChameleonResponsiveMainImageWidth" runat="server" ControlToValidate="tbxChameleonResponsiveMainImageWidth" Display="Dynamic" ErrorMessage="This filed is required." resourcekey="rfvRhumbImageWidth1Resource1.ErrorMessage"
																SetFocusOnError="True" ValidationGroup="vgEditArticle" />
															<asp:CompareValidator ID="cvChameleonResponsiveMainImageWidth" runat="server" ControlToValidate="tbxChameleonResponsiveMainImageWidth" Display="Dynamic" ErrorMessage="Please enter number only." Operator="DataTypeCheck" resourcekey="cvLightBoxGalleryNumberOfItems0Resource1.ErrorMessage"
																Type="Integer" ValidationGroup="vgTGSettings" SetFocusOnError="True" />
														</td>
													</tr>
													<tr id="trChameleonResponsiveMainImageHeight" runat="server">
														<td class="left">
															<label for="<%=tbxChameleonResponsiveMainImageHeight.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblChameleonResponsiveMainImageHeight.HelpText", true) %>" data-tooltip-position="top-right"><%=_("lblChameleonResponsiveMainImageHeight.Text") %></label>
														</td>
														<td class="right">
															<asp:TextBox ID="tbxChameleonResponsiveMainImageHeight" runat="server" CssClass="smallCentered">500</asp:TextBox>
															<asp:Label ID="lblChameleonResponsiveMainImageHeightPX" runat="server" Text="px" />
															<asp:RequiredFieldValidator ID="rfvtbxChameleonResponsiveMainImageHeight" runat="server" ControlToValidate="tbxChameleonResponsiveMainImageHeight" Display="Dynamic" ErrorMessage="This filed is required." resourcekey="rfvtbxChameleonResponsiveMainImageHeight.ErrorMessage"
																SetFocusOnError="True" ValidationGroup="vgEditArticle" />
															<asp:CompareValidator ID="cvChameleonResponsiveMainImageHeight" runat="server" ControlToValidate="tbxChameleonResponsiveMainImageHeight" Display="Dynamic" ErrorMessage="Please enter number only." Operator="DataTypeCheck" resourcekey="cvChameleonResponsiveMainImageHeight.ErrorMessage"
																Type="Integer" ValidationGroup="vgEditArticle" SetFocusOnError="True" />
														</td>
													</tr>
													<tr>
														<td class="left">
															<label for="<%=tbChameleonJpegQuality.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lbChameleonJpegQuality.Help", true) %>" data-tooltip-position="top-right"><%=_("lbChameleonJpegQuality.Text") %></label>
														</td>
														<td class="right">
															<asp:TextBox ID="tbChameleonJpegQuality" runat="server" CssClass="smallCentered">97</asp:TextBox>
															<asp:RequiredFieldValidator ID="rfvChameleonJpegQuality" runat="server" ControlToValidate="tbChameleonJpegQuality" Display="Dynamic" ErrorMessage="This filed is required." ValidationGroup="vgEditArticle" resourcekey="rfvChameleonJpegQuality.ErrorMessage" />
															<asp:RangeValidator ID="rvChameleonJpegQuality" runat="server" ControlToValidate="tbChameleonJpegQuality" Display="Dynamic" ErrorMessage="Enter value between 1 - 100." MaximumValue="100" MinimumValue="1" SetFocusOnError="True" Type="Integer" ValidationGroup="vgEditArticle" resourcekey="rvChameleonJpegQuality.ErrorMessage" />
														</td>
													</tr>
													<tr>
														<td class="left textTop">
														...
														<td class="right">
															<div class="edNews_inputGroup">
																<asp:RadioButtonList ID="rblChameleonResizeMethod" CssClass="styledRadio verticalList smallRadio" runat="server" RepeatLayout="UnorderedList">
													...
													<tr runat="server" id="trChameleonGravityGalleryInstances" visible="false">
														...
														<td class="right">
															...
															<asp:RequiredFieldValidator ID="rfvChameleonGravityGalleryInstances" runat="server" ErrorMessage="You must select Gravity gallery module" ControlToValidate="ddlChameleonGravityGalleryInstances" InitialValue="0" ValidationGroup="vgEditArticle" Display="Dynamic" SetFocusOnError="True" Enabled="False" />
														</td>
													</tr>
												</table>
											</asp:Panel>
											<asp:Panel ID="pnlLightboxGallery" runat="server">
												<table class="settings_table">
													...
													<tr runat="server" id="trGIJpegQuality">
														<td class="left">
															<label for="<%=tbGIJpegQuality.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lbGIJpegQuality.Help", true) %>" data-tooltip-position="top-right"><%=_("lbGIJpegQuality.Text") %></label>
														</td>
														<td class="right">
															<asp:TextBox ID="tbGIJpegQuality" runat="server" CssClass="smallCentered">97</asp:TextBox>
															<asp:RequiredFieldValidator ID="rfvGIJpegQuality" runat="server" ControlToValidate="tbGIJpegQuality" Display="Dynamic" ErrorMessage="This filed is required." ValidationGroup="vgEditArticle" resourcekey="rfvGIJpegQuality.ErrorMessage" />
															<asp:RangeValidator ID="rvGIJpegQuality" runat="server" ControlToValidate="tbGIJpegQuality" Display="Dynamic" ErrorMessage="Enter value between 1 - 100." MaximumValue="100" MinimumValue="1" SetFocusOnError="True" Type="Integer" ValidationGroup="vgEditArticle" resourcekey="rvGIJpegQuality.ErrorMessage" />
														</td>
													</tr>
													<tr>
														<td class="left">
											...
											<asp:Panel ID="pnlGravityGallerySettings" runat="server">
												<table class="settings_table">
													...
													<tr class="second">
														<td class="left">
															<label for="<%=tbGravityGalleryJpegQuality.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lbGravityGalleryJpegQuality.Help", true) %>" data-tooltip-position="top-right"><%=_("lbGravityGalleryJpegQuality.Text") %></label>
														</td>
														<td class="right">
															<asp:TextBox ID="tbGravityGalleryJpegQuality" runat="server" CssClass="smallCentered">97</asp:TextBox>
															<asp:RequiredFieldValidator ID="rfvGravityGalleryJpegQuality" runat="server" ControlToValidate="tbGravityGalleryJpegQuality" Display="Dynamic" ErrorMessage="This filed is required." ValidationGroup="vgEditArticle" resourcekey="rfvGravityGalleryJpegQuality.ErrorMessage" />
															<asp:RangeValidator ID="rvGravityGalleryJpegQuality" runat="server" ControlToValidate="tbGravityGalleryJpegQuality" Display="Dynamic" ErrorMessage="Enter value between 1 - 100." MaximumValue="100" MinimumValue="1" SetFocusOnError="True" Type="Integer" ValidationGroup="vgEditArticle" resourcekey="rvGravityGalleryJpegQuality.ErrorMessage" />
														</td>
													</tr>
													<tr>
														<td class="left">
											...
											<asp:Panel ID="pnlZeroGravityGallerySettings" runat="server">
												<table class="settings_table">
													<tr>
														<td class="left">
															<label for="<%=tbZeroGravityGalleryThumbnailWidth.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblZeroGravityGalleryThumbnailWidth.Help", true) %>" data-tooltip-position="top-right">
																<%=_("lblZeroGravityGalleryThumbnailWidth.Text") %>
															</label>
														</td>
														<td class="right">
															<asp:TextBox ID="tbZeroGravityGalleryThumbnailWidth" runat="server" CssClass="smallCentered">160</asp:TextBox>
														</td>
													</tr>
													<tr>
														<td class="left">
															<label for="<%=tbZeroGravityGalleryThumbnailHeight.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblZeroGravityGalleryThumbnailHeight.Help", true) %>" data-tooltip-position="top-right">
																<%=_("lblZeroGravityGalleryThumbnailHeight.Text") %>
															</label>
														</td>
														<td class="right">
															<asp:TextBox ID="tbZeroGravityGalleryThumbnailHeight" runat="server" CssClass="smallCentered">130</asp:TextBox>
														</td>
													</tr>
													<tr>
														<td class="left">
															<label for="<%=tbZeroGravityGalleryJpegQuality.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lbZeroGravityGalleryJpegQuality.Help", true) %>" data-tooltip-position="top-right">
																<%=_("lbZeroGravityGalleryJpegQuality.Text") %>
															</label>
														</td>
														<td class="right">
															<asp:TextBox ID="tbZeroGravityGalleryJpegQuality" runat="server" CssClass="smallCentered">97</asp:TextBox>
															<asp:RequiredFieldValidator ID="rfvZeroGravityGalleryJpegQuality" runat="server" ControlToValidate="tbZeroGravityGalleryJpegQuality" Display="Dynamic" ErrorMessage="This filed is required." ValidationGroup="vgSettings" resourcekey="rfvZeroGravityGalleryJpegQuality.ErrorMessage" />
															<asp:RangeValidator ID="rvZeroGravityGalleryJpegQuality" runat="server" ControlToValidate="tbZeroGravityGalleryJpegQuality" Display="Dynamic" ErrorMessage="Enter value between 1 - 100." MaximumValue="100" MinimumValue="1" SetFocusOnError="True" Type="Integer" ValidationGroup="vgSettings" resourcekey="rvZeroGravityGalleryJpegQuality.ErrorMessage" />
														</td>
													</tr>
													<tr>
														<td class="left">
															<label for="<%=rblZeroGravityGalleryResizeMethod.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblZeroGravityGalleryResizeMethod.Help", true) %>" data-tooltip-position="top-right">
																<%=_("lblZeroGravityGalleryResizeMethod.Text") %>
															</label>
														</td>
														<td class="right">
															<div class="edNews_inputGroup displayInline">
																<asp:RadioButtonList ID="rblZeroGravityGalleryResizeMethod" runat="server" CssClass="inlineList styledRadio" RepeatLayout="UnorderedList">
								...
								<div class="content tabbed">
									<asp:Panel ID="pnlCustomIntegrationAndUpload" runat="server" Visible="false">
										<div class="edg_gallery_selection_container">
											...
											<div class="mainActions floatLeft createNewGallery">
												<asp:Label runat="server" resourcekey="lblCreateNewGallery" Text="Gallery name:" ID="lblCreateNewGallery" />
												<asp:RequiredFieldValidator ID="rfvCreateNewGallery" runat="server" ControlToValidate="tbCreateNewGallery" Display="Dynamic" ErrorMessage="Please enter valid URL." SetFocusOnError="True" ValidationGroup="vgCreateNewGallery"></asp:RequiredFieldValidator>
												<div>
													<asp:TextBox runat="server" ID="tbCreateNewGallery" ValidationGroup="vgCreateNewGallery" />
													<asp:LinkButton ID="lbCreateNewGallery" runat="server" CssClass="button saveView" Text="Create new gallery" resourcekey="lbCreateNewGallery" ValidationGroup="vgCreateNewGallery" OnClick="lbCreateNewGallery_Click" />
												</div>
											</div>
										</div>
											...
											<asp:Panel ID="pnlArticleGalleryImageUpload" runat="server">
												<div class="edNews_inputGroup textCenter" style="margin-top: 20px;">
													<asp:RadioButtonList ID="rblArticleGalleryUploadType" CssClass="styledRadio inlineList" runat="server" RepeatLayout="UnorderedList" OnSelectedIndexChanged="rblArticleGalleryUploadType_SelectedIndexChanged" AutoPostBack="True">
														<asp:ListItem Value="0" class="normalRadioButton" resourcekey="liUpload" Selected="True">Upload</asp:ListItem>
														<asp:ListItem Value="1" class="normalRadioButton" resourcekey="liServer">Add from server</asp:ListItem>
														<asp:ListItem Value="2" class="normalRadioButton" resourcekey="liOpenAIImage" Enabled="false">Generate Image with OpanAi</asp:ListItem>
													</asp:RadioButtonList>
												</div>
												<asp:Panel ID="pnlArticleGalleryUploadImages" runat="server">
													...
													<div id="articleFineUploaderContainer" class="EDS_simpleFineUploader galleryFineUploader" visible="false" runat="server">
														...
														<div class="uploadControls">
															...
															<div class="actions">
																<span class="action fileSelection">
																	<asp:Label ID="lblArticleFineUploaderSelectFiles" runat="server" Text="Select images" />
																	<span class="dnnInputFileWrapper">
												...
												<asp:Panel ID="pnlOpenAIImageGeneration" class="EDS_simpleFineUploader" runat="server" Visible="False">
													<div class="uploadControls">
														<div class="edNews_inputGroup eds_labelAndInput labelAlignTop inputBox topMargin">
															<asp:Label ID="lblOpenAIImagePrompt" runat="server" resourcekey="lblOpenAIImagePrompt" AssociatedControlID="tbOpenAIImagePrompt" Text="Enter text to generate image from:"></asp:Label>
															<asp:TextBox ID="tbOpenAIImagePrompt" runat="server" CssClass="text" Text="" TextMode="MultiLine" Width="400" />
															<asp:RequiredFieldValidator ID="rfvOpenAIImagePrompt" runat="server" ControlToValidate="tbOpenAIImagePrompt" ErrorMessage="Please enter text." ValidationGroup="vgOpenAIImage" Display="Dynamic" />
														</div>
														<div class="edNews_inputGroup eds_labelAndInput">
															<asp:Label ID="lblOpenAIImageNumberOfImages" runat="server" resourcekey="lblOpenAIImageNumberOfImages" AssociatedControlID="ddlOpenAIImageNumberOfImages" Text="Select number of images:"></asp:Label>
															<asp:DropDownList ID="ddlOpenAIImageNumberOfImages" runat="server" CssClass="ddlpageitems">
														...
														<div class="edNews_inputGroup eds_labelAndInput">
															<asp:Label ID="lblOpenAIImageImageSize" runat="server" resourcekey="lblOpenAIImageImageSize" AssociatedControlID="ddlOpenAIImageImageSize" Text="Image size:"></asp:Label>
															<asp:DropDownList ID="ddlOpenAIImageImageSize" runat="server" CssClass="ddlpageitems">
																<asp:ListItem Text="512x512" Value="512x512" />
																<asp:ListItem Text="1024x1024" Value="1024x1024" Selected="True" />
															</asp:DropDownList>
														</div>
														<div class="mainActions">
															<asp:LinkButton ID="btnOpenAIImagePrompt" runat="server" resourcekey="btnOpenAIImagePrompt" Text="Generate images" ValidationGroup="vgOpenAIImage" CssClass="add" OnClick="btnOpenAIImagePrompt_Click" />
														</div>

														<asp:Panel ID="pnlOpenAiImagesGallery" runat="server" CssClass="gallery_items_container" Visible="false">
															<table class="gallery_items_table opeanAiImagesTable" width="100%" cellspacing="0" cellpadding="0">
																<tbody>
																	<tr class="main_table_header">
																		<th class="header_field"><%=Action %></th>
																	</tr>
																	<tr class="main_row">
																		<td>
																			<table width="100%" cellspacing="0" cellpadding="0">
																				<tbody>
																					<asp:Repeater ID="repOpeanAiImages" OnItemCommand="repOpeanAiImages_ItemCommand" runat="server" EnableViewState="true">
																						<ItemTemplate>
																							<tr>
																								<td class="image">
																									<div class="wrapper">
																										<asp:Image ID="imgArticleGalleryImage" CommandName="SetArticleImage" ImageUrl='<%#Eval("Url")%>' CssClass="image" runat="server" />
																									</div>
																								</td>
																								<td class="action">
																									<asp:LinkButton ID="lbSetArticleImageOpaAI" runat="server" CommandArgument='<%# Eval("Url") %>' CommandName="SetArticleImage" CssClass="action_btn article_img" resourcekey="lbSetArticleImageArtGalleryResource1">Set as main article image</asp:LinkButton>
																									<asp:LinkButton ID="lbAddOpenAIImageToGallery" runat="server" CommandArgument='<%# Eval("Url") %>' CommandName="AddImageToGallery" CssClass="action_btn article_img details_article_image" resourcekey="lbAddOpenAIImageToGallery">Add image to gallery</asp:LinkButton>
																								</td>
																							</tr>
																						</ItemTemplate>
																					</asp:Repeater>
														...
														<div class="uploadify_container" runat="server" id="divOpenAIMessage" visible="false">
															<asp:Label ID="lblOpenAIMessage" runat="server" />
														</div>
													</div>
												</asp:Panel>
											</asp:Panel>
							...
							<div class="section_box no_top_margin">
								<div class="content grey">
									<div class="gallery_items_container">
										<div id="divAritcleGaleryGravityToken" class="add_video_by_url" runat="server" visible="false">
											<p>
												<asp:Label runat="server" resourcekey="lblAritcleGaleryGravityToken" Text="Galery token:" ID="lblAritcleGaleryGravityToken" />
												<asp:TextBox runat="server" ID="tbAritcleGaleryGravityToken" CssClass="token_box" ReadOnly="True" Width="250" />
											</p>
										</div>
									...
									<div class="padded textCenter">
										<div id="divGalleryOrderBy" runat="server" visible="false" style="display: inline; padding-left: 20px">
											<asp:Label ID="lblGalleryOrderBy" runat="server" Text="Sort:" resourcekey="lblGalleryOrderBy" />
											&nbsp;
												<asp:DropDownList ID="ddlGalleryOrderBy" runat="server" AutoPostBack="True" CssClass="ddlpageitems" OnSelectedIndexChanged="ddlGalleryOrderBy_SelectedIndexChanged">
													<asp:ListItem resourcekey="liAscending" Text="Ascending" Value="0" />
													<asp:ListItem resourcekey="liDescending" Text="Descending" Value="1" />
												</asp:DropDownList>
										</div>
										<div id="mediaPageManagment" runat="server" visible="false" style="display: inline; padding-left: 20px">
							...
							<Columns>
								<asp:TemplateField HeaderText="Actions">
									...
									<ItemTemplate>
										...
										<asp:LinkButton ID="lbDocDelete" runat="server" CausesValidation="false" CommandName="Delete" CssClass="action_btn red_x" OnClientClick="return AlertConfirm('document');" resourcekey="lbDeleteDocResource1" ToolTip="<%#Deletethisdocument%>" CommandArgument='<%# Eval("DocEntryID") %>' />
									</ItemTemplate>
								...
								<asp:TemplateField HeaderText="TitleDescription">
									...
									<ItemTemplate>
										<asp:Label ID="lblDocUploadTitle" runat="server" CssClass="title" Text='<%# Eval("Title") == null || Eval("Title") == DBNull.Value? "" :HttpUtility.HtmlDecode(Eval("Title").ToString()) %>' />
										<asp:Label ID="lblDocUploadDesc" runat="server" CssClass="description" Text='<%# Eval("Description") == null || Eval("Description") == DBNull.Value? "" :  HttpUtility.HtmlDecode(Eval("Description").ToString()) %>' />
										...
										<Columns>
											<asp:TemplateField HeaderText="Actions">
												...
												<ItemTemplate>
													...
													<asp:LinkButton ID="lbDeleteLink" CssClass="action_btn red_x" runat="server" CausesValidation="false" CommandName="Delete" ToolTip="<%#Deletethislink%>" OnClientClick="return AlertConfirm('link');" CommandArgument='<%# ((GridViewRow) Container).RowIndex %>' />
												</ItemTemplate>
												<HeaderStyle CssClass="actions" />
												<ItemStyle CssClass="actions" />
											</asp:TemplateField>
											...
											<asp:TemplateField HeaderText="Show">
												...
												<EditItemTemplate>
													<asp:CheckBox CssClass="normalCheckBox" runat="server" ID="cbLinkVisible" Enabled="true" Checked='<%#Convert.ToBoolean(Eval("Visible"))%>' />
												</EditItemTemplate>
												<HeaderStyle CssClass="tdShow" />
												<ItemStyle CssClass="tdShow" />
											</asp:TemplateField>
										...
										<asp:Panel ID="pnlChangeTheme" runat="server">
											...
											<asp:Panel ID="pnlSelectThemes" runat="server" Visible="false">
												<table class="settings_table no_margin">
													...
													<tr>
														<td class="left">
															<label for="<%=ddlZeroGravityGallerySelectTemplate.ClientID %>" class="edNews_tooltip" data-tooltip-content="<%=_("lblZeroGravityGallerySelectTemplate.Help", true) %>" data-tooltip-position="top-right"><%=_("lblZeroGravityGallerySelectTemplate.Text") %></label>
														</td>
														<td class="right">
															<asp:DropDownList ID="ddlZeroGravityGallerySelectTemplate" runat="server">
															</asp:DropDownList>
														</td>
													</tr>
												</table>
				...
				<asp:Panel ID="tblVariousOptions" CssClass="section_box white_border_1 dark_grey olive_green edn_admin_progress_overlay_container edn_variousOptions" runat="server">
					<h1 class="section_box_title">
						<span>
							<%=PublishDetails %></span></h1>
								...
								<asp:Panel ID="pnlAddPerArticlePermissions" runat="server" Visible="false" CssClass="rounded_box grey per_article_permissions">
									...
									<asp:GridView ID="gvPermissionDefault" runat="server" AutoGenerateColumns="false" CellPadding="0" CssClass="strippedTable fullWidthTable textCenter edNews_permissionsTable edNews_addEditPermissions" EnableModelValidation="True" GridLines="None">
										<Columns>
											...
											<asp:TemplateField HeaderText="PaidContent">
												<ItemTemplate>
													<asp:CheckBox CssClass="normalCheckBox" ID="cbPaidContent" runat="server" Checked='<%# Eval("PaidContent") %>' Enabled="false" />
												</ItemTemplate>
											</asp:TemplateField>
										</Columns>
									...
									<asp:GridView ID="gvRolePremissions" runat="server" AutoGenerateColumns="false" CellPadding="0" ShowHeader="False" CssClass="strippedTable fullWidthTable textCenter edNews_permissionsTable edNews_addEditPermissions" EnableModelValidation="True" GridLines="None">
										<Columns>
											...
											<asp:TemplateField>
												<ItemTemplate>
													<asp:CheckBox CssClass="normalCheckBox" ID="cbPaidContent" runat="server" Checked='<%# Eval("PaidContent") %>' />
												</ItemTemplate>
											</asp:TemplateField>
										</Columns>
									</asp:GridView>
									<div>
										<table class="strippedTable fullWidthTable textCenter edNews_permissionsTable edNews_addEditPermissions" cellspacing="0" cellpadding="0" border="0" style="position: relative; margin-bottom: 15px;">
											<tr>
												...
												<td>
													<asp:CheckBox CssClass="normalCheckBox" ID="cbPaidContentToUnauthorizedUser" runat="server" Checked='<%# Eval("PaidContent") %>' />
												</td>
											</tr>
										</table>
									</div>
				...
				<asp:Panel ID="pnlAddTopicForComments" runat="server" Visible="false">
					<div class="edn_admin_progress_overlay_container">
						<div style="margin: 25px 0 0 3px;">
							<label>
								<label for="<%=cbAddTopicForComments.ClientID %>" class="edNews_tooltip" data-tooltip-content='<%=_("lblAddTopicForComments.HelpText")%>' data-tooltip-position="top-right" visible="False"><%=_("lblAddTopicForComments")%></label>
							</label>
							<div class="switchCheckbox noLabel">
								<asp:CheckBox CssClass="normalCheckBox" ID="cbAddTopicForComments" Text="Create forum topic" runat="server" />
							</div>
						</div>
					</div>
				</asp:Panel>
				...
				<div class="main_action_buttons">
					...
					<div class="mainActions">
						...
						<asp:LinkButton ID="btnAddAndView" CssClass="saveView" Visible="false" runat="server" OnClick="AddAndView_Click" Text="Save and view" OnClientClick="return EdsSaveButtonClick('vgEditArticle');" ValidationGroup="vgEditArticle" resourcekey="btnAddAndView" />
						<asp:LinkButton ID="btnUpdateArticle" CssClass="downSave" Visible="false" runat="server" OnClick="UpdateArticle_Click" Text="Update article" OnClientClick="return EdsSaveButtonClick('vgEditArticle');" ValidationGroup="vgEditArticle" resourcekey="btnUpdateArticleResource1" />
						<asp:LinkButton ID="btnUpdateClose" CssClass="downSaveClose" Visible="false" runat="server" OnClick="UpdateClose_Click" Text="Update &amp;amp; Close" OnClientClick="return EdsSaveButtonClick('vgEditArticle');" ValidationGroup="vgEditArticle" resourcekey="btnUpdateCloseResource1" />
						<asp:LinkButton ID="btnUpdateAndView" CssClass="saveView" Visible="false" runat="server" OnClick="UpdateAndView_Click" Text="Update &amp;amp; View" OnClientClick="return EdsSaveButtonClick('vgEditArticle');" ValidationGroup="vgEditArticle" resourcekey="btnGoArticleResource1" />
						<asp:LinkButton ID="btnCancel" CssClass="cancel" runat="server" OnClick="Cancel_Click" Text="Cancel" CausesValidation="false" resourcekey="btnCancel" />
					</div>
					<div class="mainActions smallActions textRight noMargin" runat="server" id="divDeleteArticle">
						<asp:LinkButton ID="lbDeleteArticle" runat="server" CssClass="delete" OnClick="lbDeleteArticle_Click" resourcekey="lbDeleteArticleResource1" ToolTip="Delete article" />
					</div>
...
<script type="text/javascript">
	...
	var eds_edn__maps_iconinfos = <%=markerIconOptionsJson %>;
	var eds_edn__maps_iconFolder = '<%=_ControlPath + "images/markers/" %>';
	...
	function openLocalizationPreloader() {
		...
		eds3_5_jq('#<%= pnlContentLocalizationDetails.ClientID%>').addClass('edNews_loading');
		return true;
	}

	function openImageLocalizationPreloader() {
		eds3_5_jq('#<%= pnlImagelocalization.ClientID%>').addClass('edNews_loading');
	}

	function GenerateAIArticle() {
		var eds__requestGenerateAIArticle = false;
		if (eds__requestGenerateAIArticle)
			return false;
		let eds__generatetext = eds3_5_jq('#<%=tbTextToGenerateArticle.ClientID%>').val();
		let eds_language = eds3_5_jq('#<%=ddlAIGenerateArticleLanguage.ClientID%>').val();
		let eds__generatetextstyle = eds3_5_jq('#<%=ddlAIGenerateArticleStyle.ClientID%>').val();

		eds__requestGenerateAIArticle = true;
		eds3_5_jq('#eds__generateAIArticleMainWrapper').addClass('loading');
		eds3_5_jq("#eds__generateAIArticleMainWrapper :input").prop('disabled', true);
		$.ajax({
			type: 'GET',
			url: '<%=_ControlPath%>/ashx/ArticleEditAction.ashx',
			dataType: 'json',
			...
			data: {
				...
				tabid: <%=TabId%>,
				articleid:<%=editArticleId%>,
				action: 'generateaiarticle',
				language: eds_language,
				generatetext: encodeURIComponent(eds__generatetext),
				generatetype: encodeURIComponent(eds__generatetextstyle)
			},
			success: function (response) {
				
				eds__requestGenerateAIArticle = false;
				eds3_5_jq('#<%=tbAIGeneratedArticle.ClientID%>').text(response.article);
				eds3_5_jq('#<%=tbAIGeneratedArticleTitle.ClientID%>').val(response.title);
				eds3_5_jq('#<%=tbAIGeneratedArticleSubtitle.ClientID%>').val(response.subtitle);
				eds3_5_jq('#<%=tbAIGeneratedArticleSummary.ClientID%>').val(response.summary);
				eds3_5_jq('#<%=tbAIGeneratedArticleTags.ClientID%>').val(response.tags);
				eds3_5_jq('#eds__generatedArticleTextWrapper').css('display', 'block');
			},
			complete: function () {
				eds__requestGenerateAIArticle = false;
				eds3_5_jq('#eds__generateAIArticleMainWrapper').removeClass('loading');
				eds3_5_jq("#eds__generateAIArticleMainWrapper :input").prop('disabled', false);
			}
		});
		return false;
	};

	function initOpenAiArticleGenerate() {
		eds3_5_jq('#<%= pnlOPeanAIGenerateArticleWindow.ClientID%>').css('display', 'block');
		eds3_5_jq('#<%=tbTextToGenerateArticle.ClientID%>').val(eds3_5_jq('#<%=tbArticleTitle.ClientID%>').val())
	};
	...
	function InitCFTimeTimePickers(id) {
		eds3_5_jq(id).timePicker({
			startTime: "00:00",
	...
	var edn_admin_localization = {
		...
		gmaps_token_editor_edit_marker_marker_icon: '<%=IconText%>',
	...
	function ClientValidateEmbedURL(source, arguments) {
		...
		var s = textBox.value;
		if ((s.indexOf("youtube.com") != -1 && s.indexOf("v=") != -1) || (s.indexOf("youtube.com") != -1 && s.indexOf("/shorts/") != -1) || (s.indexOf("youtu.be/") != -1) || (s.indexOf("vimeo.com") != -1) || (s.indexOf("wistia.com") != -1) || (s.indexOf("wistia.net") != -1))
	...
	function changeMetaDataTemplate(e, templateType) {
		$(e.target).prop("disabled", true);
		$.ajax({
			type: 'GET',
			url: '<%=_ControlPath%>/ashx/GetFileData.ashx',
			dataType: 'json',
			data: {
				portalId: <%=PortalId%>,
				moduleId: <%=ModuleId%>,
				...
				<div class="dialog_wrapper">\
					...
					<p class="option">\
						...
						<label for="gallery_item_token_onclick_nothing">\
							<%=None%></label></p>\
					<p class="option">\
						<input type="checkbox" class="normalCheckBox" id="gallery_item_token_srcset" name="title" value="true" />\
						<label for="gallery_item_token_srcset">\
							<%=CreateSrcSet %></label></p>\
					<p class="option">\
	...
	<%=includeAILocalisatioSeoOptionsJS%>
	...
	function pageLoad(sender, args) {
		if (args.get_isPartialLoad()) {
			(function ($) {
				...
				if (eds3_5_jq('#<%=collapsible_seo_box_content.ClientID%>').css('display') == 'block') {
					eds3_5_jq('.edsTabGeneral').click();
