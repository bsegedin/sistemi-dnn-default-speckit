...
# Implementation Plan: Shared Theme Body Control & ThemeHelpers

**Branch**: `001-implement-shared-body` | **Date**: 2025-09-25 | **Spec**: specs/001-implement-shared-body/spec.md
**Input**: Feature specification from `specs/001-implement-shared-body/spec.md`
...
## Summary
Implement a single shared body control `_inc-theme-body.ascx` that hosts all panes and applies layout via wrapper-passed attributes (`LayoutVariant`, `PaneLayout`, `HeaderStyle`, `ShowBreadcrumb`). Standardize helpers in `App_Code/BaseTheme/ThemeHelpers.cs`. Expose Figma tokens as CSS custom properties with Desktop/Mobile parity. Enforce WCAG 2.1 AA and performance budgets. Use DDR Menu with Razor templates for "Main menu" and "Service menu" and Bootstrap Offcanvas for mobile navigation.
...
- Performance: Estimated budgets respected (CSS ≤ 200 KB, JS ≤ 100 KB at FCP for impacted pages)?
- DNN contracts: Do skins/containers and resource registrations follow DNN conventions and packaging rules?
- Versioning: Expected SemVer bump type and migration notes identified.
...
---
*Based on Constitution v1.9.1 - See `.specify/memory/constitution.md`*
